...
public class AdvanceReceivedPaymentApi {
     ...
     */
    public UnitReceivedPaymentResponse execute(String paymentId) throws ApiException {
        ApiResponse<UnitReceivedPaymentResponse> localVarResp = executeWithHttpInfo(paymentId);
     ...
     */
    public ApiResponse<UnitReceivedPaymentResponse> executeWithHttpInfo(String paymentId) throws ApiException {
     ...
     */
    public okhttp3.Call executeAsync(String paymentId, final ApiCallback<UnitReceivedPaymentResponse> _callback) throws ApiException {
