...
public class ApproveCheckPaymentApi {
    ...
    public UnitCheckPaymentResponse execute(String checkPaymentId, ApproveCheckPaymentRequest approveCheckPaymentRequest) throws ApiException {
        ApiResponse<UnitCheckPaymentResponse> localVarResp = executeWithHttpInfo(checkPaymentId, approveCheckPaymentRequest);
     ...
     */
    public okhttp3.Call executeAsync(String checkPaymentId, ApproveCheckPaymentRequest approveCheckPaymentRequest, final ApiCallback<UnitCheckPaymentResponse> _callback) throws ApiException {
