...
public class ApproveCheckPaymentApi {
    ...
    public UnitCheckPaymentResponse execute(String checkPaymentId, ExecuteRequest20 executeRequest20) throws ApiException {
        ApiResponse<UnitCheckPaymentResponse> localVarResp = executeWithHttpInfo(checkPaymentId, executeRequest20);
     ...
     */
    public ApiResponse<UnitCheckPaymentResponse> executeWithHttpInfo(String checkPaymentId, ExecuteRequest20 executeRequest20) throws ApiException {
     ...
     */
    public okhttp3.Call executeAsync(String checkPaymentId, ExecuteRequest20 executeRequest20, final ApiCallback<UnitCheckPaymentResponse> _callback) throws ApiException {
