...
public class ArchiveCustomerApi {
    ...
    public UnitCustomerResponse execute(String customerId, ArchiveCustomerRequest archiveCustomerRequest) throws ApiException {
        ApiResponse<UnitCustomerResponse> localVarResp = executeWithHttpInfo(customerId, archiveCustomerRequest);
     ...
     */
    public okhttp3.Call executeAsync(String customerId, ArchiveCustomerRequest archiveCustomerRequest, final ApiCallback<UnitCustomerResponse> _callback) throws ApiException {
