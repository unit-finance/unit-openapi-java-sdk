...
public class CancelApplicationApi {
    ...
    public UnitCancelApplicationResponse execute(String applicationId, ExecuteRequest executeRequest) throws ApiException {
        ApiResponse<UnitCancelApplicationResponse> localVarResp = executeWithHttpInfo(applicationId, executeRequest);
     ...
     */
    public ApiResponse<UnitCancelApplicationResponse> executeWithHttpInfo(String applicationId, ExecuteRequest executeRequest) throws ApiException {
        okhttp3.Call localVarCall = executeValidateBeforeCall(applicationId, executeRequest, null);
        Type localVarReturnType = new TypeToken<UnitCancelApplicationResponse>(){}.getType();
     ...
     */
    public okhttp3.Call executeAsync(String applicationId, ExecuteRequest executeRequest, final ApiCallback<UnitCancelApplicationResponse> _callback) throws ApiException {
