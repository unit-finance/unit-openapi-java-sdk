...
public class CancelApplicationApi {
    ...
    public UnitCancelApplicationResponse execute(String applicationId, CancelApplicationRequest cancelApplicationRequest) throws ApiException {
        ApiResponse<UnitCancelApplicationResponse> localVarResp = executeWithHttpInfo(applicationId, cancelApplicationRequest);
     ...
     */
    public okhttp3.Call executeAsync(String applicationId, CancelApplicationRequest cancelApplicationRequest, final ApiCallback<UnitCancelApplicationResponse> _callback) throws ApiException {
