...
public class CancelPaymentApi {
    ...
    public UnitPaymentResponse execute(String paymentId) throws ApiException {
        ApiResponse<UnitPaymentResponse> localVarResp = executeWithHttpInfo(paymentId);
     ...
     */
    public okhttp3.Call executeAsync(String paymentId, final ApiCallback<UnitPaymentResponse> _callback) throws ApiException {
