...
public class CloseAnAccountApi {
    ...
    public UnitAccountResponse execute(String accountId, ExecuteRequest4 executeRequest4) throws ApiException {
        ApiResponse<UnitAccountResponse> localVarResp = executeWithHttpInfo(accountId, executeRequest4);
     ...
     */
    public ApiResponse<UnitAccountResponse> executeWithHttpInfo(String accountId, ExecuteRequest4 executeRequest4) throws ApiException {
     ...
     */
    public okhttp3.Call executeAsync(String accountId, ExecuteRequest4 executeRequest4, final ApiCallback<UnitAccountResponse> _callback) throws ApiException {
