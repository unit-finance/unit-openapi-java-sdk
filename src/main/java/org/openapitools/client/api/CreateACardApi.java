...
public class CreateACardApi {
    ...
    public UnitCardResponse execute(CreateCard createCard) throws ApiException {
        ApiResponse<UnitCardResponse> localVarResp = executeWithHttpInfo(createCard);
     ...
     */
    public okhttp3.Call executeAsync(CreateCard createCard, final ApiCallback<UnitCardResponse> _callback) throws ApiException {
