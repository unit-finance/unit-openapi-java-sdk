...
public class CreateADocumentForAnApplicationApi {
    ...
    public UnitDocumentResponse execute(String applicationId) throws ApiException {
        ApiResponse<UnitDocumentResponse> localVarResp = executeWithHttpInfo(applicationId);
     ...
     */
    public okhttp3.Call executeAsync(String applicationId, final ApiCallback<UnitDocumentResponse> _callback) throws ApiException {
