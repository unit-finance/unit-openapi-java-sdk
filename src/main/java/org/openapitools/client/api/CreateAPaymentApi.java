...
public class CreateAPaymentApi {
    ...
    public UnitPaymentResponse execute(ExecuteRequest6 executeRequest6) throws ApiException {
        ApiResponse<UnitPaymentResponse> localVarResp = executeWithHttpInfo(executeRequest6);
     ...
     */
    public ApiResponse<UnitPaymentResponse> executeWithHttpInfo(ExecuteRequest6 executeRequest6) throws ApiException {
     ...
     */
    public okhttp3.Call executeAsync(ExecuteRequest6 executeRequest6, final ApiCallback<UnitPaymentResponse> _callback) throws ApiException {
