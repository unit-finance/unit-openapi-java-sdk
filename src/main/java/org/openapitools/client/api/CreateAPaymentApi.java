...
public class CreateAPaymentApi {
    ...
    public UnitPaymentResponse execute(CreatePayment createPayment) throws ApiException {
        ApiResponse<UnitPaymentResponse> localVarResp = executeWithHttpInfo(createPayment);
     ...
     */
    public okhttp3.Call executeAsync(CreatePayment createPayment, final ApiCallback<UnitPaymentResponse> _callback) throws ApiException {
