...
public class CreateARepaymentApi {
    ...
    public UnitRepaymentResponse execute(CreateRepayment createRepayment) throws ApiException {
        ApiResponse<UnitRepaymentResponse> localVarResp = executeWithHttpInfo(createRepayment);
     ...
     */
    public okhttp3.Call executeAsync(CreateRepayment createRepayment, final ApiCallback<UnitRepaymentResponse> _callback) throws ApiException {
