...
public class CreateApplicationFormApi {
    ...
    public UnitApplicationFormResponse execute(ExecuteRequest1 executeRequest1) throws ApiException {
        ApiResponse<UnitApplicationFormResponse> localVarResp = executeWithHttpInfo(executeRequest1);
     ...
     */
    public ApiResponse<UnitApplicationFormResponse> executeWithHttpInfo(ExecuteRequest1 executeRequest1) throws ApiException {
     ...
     */
    public okhttp3.Call executeAsync(ExecuteRequest1 executeRequest1, final ApiCallback<UnitApplicationFormResponse> _callback) throws ApiException {
