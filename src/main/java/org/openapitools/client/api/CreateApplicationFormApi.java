...
public class CreateApplicationFormApi {
    ...
    public UnitApplicationFormResponse execute(CreateApplicationForm createApplicationForm) throws ApiException {
        ApiResponse<UnitApplicationFormResponse> localVarResp = executeWithHttpInfo(createApplicationForm);
    ...
    public ApiResponse<UnitApplicationFormResponse> executeWithHttpInfo(CreateApplicationForm createApplicationForm) throws ApiException {
        ...
        Type localVarReturnType = new TypeToken<UnitApplicationFormResponse>(){}.getType();
     ...
     */
    public okhttp3.Call executeAsync(CreateApplicationForm createApplicationForm, final ApiCallback<UnitApplicationFormResponse> _callback) throws ApiException {
