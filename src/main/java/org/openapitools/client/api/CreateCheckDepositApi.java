...
public class CreateCheckDepositApi {
    ...
    public UnitCheckDepositResponse execute(ExecuteRequest14 executeRequest14) throws ApiException {
        ApiResponse<UnitCheckDepositResponse> localVarResp = executeWithHttpInfo(executeRequest14);
     ...
     */
    public ApiResponse<UnitCheckDepositResponse> executeWithHttpInfo(ExecuteRequest14 executeRequest14) throws ApiException {
     ...
     */
    public okhttp3.Call executeAsync(ExecuteRequest14 executeRequest14, final ApiCallback<UnitCheckDepositResponse> _callback) throws ApiException {
