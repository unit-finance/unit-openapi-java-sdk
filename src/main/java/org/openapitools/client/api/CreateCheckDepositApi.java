...
public class CreateCheckDepositApi {
    ...
    public UnitCheckDepositResponse execute(CreateCheckDeposit createCheckDeposit) throws ApiException {
        ApiResponse<UnitCheckDepositResponse> localVarResp = executeWithHttpInfo(createCheckDeposit);
     ...
     */
    public okhttp3.Call executeAsync(CreateCheckDeposit createCheckDeposit, final ApiCallback<UnitCheckDepositResponse> _callback) throws ApiException {
