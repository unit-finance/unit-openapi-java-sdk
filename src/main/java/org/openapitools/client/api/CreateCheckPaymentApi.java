...
public class CreateCheckPaymentApi {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public CreateCheckPaymentApi() {
        this(Configuration.getDefaultApiClient());
    }

    public CreateCheckPaymentApi(ApiClient apiClient) {
    ...
    public UnitCheckPaymentResponse execute(ExecuteRequest19 executeRequest19) throws ApiException {
        ApiResponse<UnitCheckPaymentResponse> localVarResp = executeWithHttpInfo(executeRequest19);
     ...
     */
    public ApiResponse<UnitCheckPaymentResponse> executeWithHttpInfo(ExecuteRequest19 executeRequest19) throws ApiException {
     ...
     */
    public okhttp3.Call executeAsync(ExecuteRequest19 executeRequest19, final ApiCallback<UnitCheckPaymentResponse> _callback) throws ApiException {
