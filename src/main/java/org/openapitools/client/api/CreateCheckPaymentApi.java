...
public class CreateCheckPaymentApi {
    ...
    public UnitCheckPaymentResponse execute(CreateCheckPayment createCheckPayment) throws ApiException {
        ApiResponse<UnitCheckPaymentResponse> localVarResp = executeWithHttpInfo(createCheckPayment);
     ...
     */
    public okhttp3.Call executeAsync(CreateCheckPayment createCheckPayment, final ApiCallback<UnitCheckPaymentResponse> _callback) throws ApiException {
