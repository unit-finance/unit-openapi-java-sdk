...
public class CreateCounterpartyApi {
    ...
    public UnitCounterpartyResponse execute(ExecuteRequest7 executeRequest7) throws ApiException {
        ApiResponse<UnitCounterpartyResponse> localVarResp = executeWithHttpInfo(executeRequest7);
     ...
     */
    public ApiResponse<UnitCounterpartyResponse> executeWithHttpInfo(ExecuteRequest7 executeRequest7) throws ApiException {
     ...
     */
    public okhttp3.Call executeAsync(ExecuteRequest7 executeRequest7, final ApiCallback<UnitCounterpartyResponse> _callback) throws ApiException {
