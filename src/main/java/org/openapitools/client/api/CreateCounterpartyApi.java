...
public class CreateCounterpartyApi {
    ...
    public UnitCounterpartyResponse execute(CreateCounterparty createCounterparty) throws ApiException {
        ApiResponse<UnitCounterpartyResponse> localVarResp = executeWithHttpInfo(createCounterparty);
     ...
     */
    public okhttp3.Call executeAsync(CreateCounterparty createCounterparty, final ApiCallback<UnitCounterpartyResponse> _callback) throws ApiException {
