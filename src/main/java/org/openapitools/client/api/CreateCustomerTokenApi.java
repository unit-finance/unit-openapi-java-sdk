...
public class CreateCustomerTokenApi {
    ...
    public UnitCustomerTokenResponse execute(String customerId, CreateCustomerToken createCustomerToken) throws ApiException {
        ApiResponse<UnitCustomerTokenResponse> localVarResp = executeWithHttpInfo(customerId, createCustomerToken);
    ...
    public ApiResponse<UnitCustomerTokenResponse> executeWithHttpInfo(String customerId, CreateCustomerToken createCustomerToken) throws ApiException {
        ...
        Type localVarReturnType = new TypeToken<UnitCustomerTokenResponse>(){}.getType();
     ...
     */
    public okhttp3.Call executeAsync(String customerId, CreateCustomerToken createCustomerToken, final ApiCallback<UnitCustomerTokenResponse> _callback) throws ApiException {
