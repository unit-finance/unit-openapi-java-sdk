...
public class CreateCustomerTokenApi {
    ...
    public UnitCustomerTokenResponse execute(String customerId, ExecuteRequest16 executeRequest16) throws ApiException {
        ApiResponse<UnitCustomerTokenResponse> localVarResp = executeWithHttpInfo(customerId, executeRequest16);
     ...
     */
    public ApiResponse<UnitCustomerTokenResponse> executeWithHttpInfo(String customerId, ExecuteRequest16 executeRequest16) throws ApiException {
     ...
     */
    public okhttp3.Call executeAsync(String customerId, ExecuteRequest16 executeRequest16, final ApiCallback<UnitCustomerTokenResponse> _callback) throws ApiException {
