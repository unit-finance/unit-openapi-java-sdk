...
public class CreateCustomerTokenVerificationApi {
    ...
    public UnitCustomerTokenVerificationResponse execute(String customerId, CreateCustomerTokenVerification createCustomerTokenVerification) throws ApiException {
        ApiResponse<UnitCustomerTokenVerificationResponse> localVarResp = executeWithHttpInfo(customerId, createCustomerTokenVerification);
     ...
     */
    public okhttp3.Call executeAsync(String customerId, CreateCustomerTokenVerification createCustomerTokenVerification, final ApiCallback<UnitCustomerTokenVerificationResponse> _callback) throws ApiException {
