...
public class CreateFeeApi {
    ...
    public UnitFeeResponse execute(Object body) throws ApiException {
        ApiResponse<UnitFeeResponse> localVarResp = executeWithHttpInfo(body);
     ...
     */
    public okhttp3.Call executeAsync(Object body, final ApiCallback<UnitFeeResponse> _callback) throws ApiException {
