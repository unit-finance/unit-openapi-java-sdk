...
public class CreateOrgApiTokenApi {
    ...
    public UnitApiTokenResponse execute(String userId, CreateApiToken createApiToken) throws ApiException {
        ApiResponse<UnitApiTokenResponse> localVarResp = executeWithHttpInfo(userId, createApiToken);
     ...
     */
    public okhttp3.Call executeAsync(String userId, CreateApiToken createApiToken, final ApiCallback<UnitApiTokenResponse> _callback) throws ApiException {
