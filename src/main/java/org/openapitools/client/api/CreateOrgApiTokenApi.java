...
public class CreateOrgApiTokenApi {
    ...
    public UnitApiTokenResponse execute(String userId, ExecuteRequest15 executeRequest15) throws ApiException {
        ApiResponse<UnitApiTokenResponse> localVarResp = executeWithHttpInfo(userId, executeRequest15);
     ...
     */
    public ApiResponse<UnitApiTokenResponse> executeWithHttpInfo(String userId, ExecuteRequest15 executeRequest15) throws ApiException {
     ...
     */
    public okhttp3.Call executeAsync(String userId, ExecuteRequest15 executeRequest15, final ApiCallback<UnitApiTokenResponse> _callback) throws ApiException {
