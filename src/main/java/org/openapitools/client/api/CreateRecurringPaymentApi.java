...
public class CreateRecurringPaymentApi {
    ...
    public UnitRecurringPaymentResponse execute(ExecuteRequest8 executeRequest8) throws ApiException {
        ApiResponse<UnitRecurringPaymentResponse> localVarResp = executeWithHttpInfo(executeRequest8);
     ...
     */
    public ApiResponse<UnitRecurringPaymentResponse> executeWithHttpInfo(ExecuteRequest8 executeRequest8) throws ApiException {
     ...
     */
    public okhttp3.Call executeAsync(ExecuteRequest8 executeRequest8, final ApiCallback<UnitRecurringPaymentResponse> _callback) throws ApiException {
