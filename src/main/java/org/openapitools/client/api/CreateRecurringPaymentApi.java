...
public class CreateRecurringPaymentApi {
    ...
    public UnitRecurringPaymentResponse execute(CreateRecurringPayment createRecurringPayment) throws ApiException {
        ApiResponse<UnitRecurringPaymentResponse> localVarResp = executeWithHttpInfo(createRecurringPayment);
     ...
     */
    public okhttp3.Call executeAsync(CreateRecurringPayment createRecurringPayment, final ApiCallback<UnitRecurringPaymentResponse> _callback) throws ApiException {
