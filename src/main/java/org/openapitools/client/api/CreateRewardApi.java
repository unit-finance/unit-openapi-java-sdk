...
public class CreateRewardApi {
    ...
    public UnitRewardResponse execute(ExecuteRequest12 executeRequest12) throws ApiException {
        ApiResponse<UnitRewardResponse> localVarResp = executeWithHttpInfo(executeRequest12);
     ...
     */
    public ApiResponse<UnitRewardResponse> executeWithHttpInfo(ExecuteRequest12 executeRequest12) throws ApiException {
     ...
     */
    public okhttp3.Call executeAsync(ExecuteRequest12 executeRequest12, final ApiCallback<UnitRewardResponse> _callback) throws ApiException {
