...
public class DeclineAuthorizationRequestApi {
    ...
    public UnitAuthorizationRequestResponse execute(String authorizationId, ExecuteRequest11 executeRequest11) throws ApiException {
        ApiResponse<UnitAuthorizationRequestResponse> localVarResp = executeWithHttpInfo(authorizationId, executeRequest11);
     ...
     */
    public ApiResponse<UnitAuthorizationRequestResponse> executeWithHttpInfo(String authorizationId, ExecuteRequest11 executeRequest11) throws ApiException {
     ...
     */
    public okhttp3.Call executeAsync(String authorizationId, ExecuteRequest11 executeRequest11, final ApiCallback<UnitAuthorizationRequestResponse> _callback) throws ApiException {
