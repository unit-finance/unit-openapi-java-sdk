...
public class DeclineAuthorizationRequestApi {
    ...
    public UnitAuthorizationRequestResponse execute(String authorizationId, DeclineAuthorizationRequest declineAuthorizationRequest) throws ApiException {
        ApiResponse<UnitAuthorizationRequestResponse> localVarResp = executeWithHttpInfo(authorizationId, declineAuthorizationRequest);
     ...
     */
    public okhttp3.Call executeAsync(String authorizationId, DeclineAuthorizationRequest declineAuthorizationRequest, final ApiCallback<UnitAuthorizationRequestResponse> _callback) throws ApiException {
