...
public class FreezeAnAccountApi {
    ...
    public UnitAccountResponse execute(String accountId, ExecuteRequest3 executeRequest3) throws ApiException {
        ApiResponse<UnitAccountResponse> localVarResp = executeWithHttpInfo(accountId, executeRequest3);
     ...
     */
    public ApiResponse<UnitAccountResponse> executeWithHttpInfo(String accountId, ExecuteRequest3 executeRequest3) throws ApiException {
     ...
     */
    public okhttp3.Call executeAsync(String accountId, ExecuteRequest3 executeRequest3, final ApiCallback<UnitAccountResponse> _callback) throws ApiException {
