...
public class FreezeAnAccountApi {
    ...
    public UnitAccountResponse execute(String accountId, FreezeAccountRequest freezeAccountRequest) throws ApiException {
        ApiResponse<UnitAccountResponse> localVarResp = executeWithHttpInfo(accountId, freezeAccountRequest);
     ...
     */
    public okhttp3.Call executeAsync(String accountId, FreezeAccountRequest freezeAccountRequest, final ApiCallback<UnitAccountResponse> _callback) throws ApiException {
