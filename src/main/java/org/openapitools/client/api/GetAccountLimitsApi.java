...
import org.openapitools.client.model.UnitGetAccountLimitsResponse;
...
public class GetAccountLimitsApi {
     ...
     */
    public UnitGetAccountLimitsResponse execute(String accountId) throws ApiException {
        ApiResponse<UnitGetAccountLimitsResponse> localVarResp = executeWithHttpInfo(accountId);
     ...
     */
    public ApiResponse<UnitGetAccountLimitsResponse> executeWithHttpInfo(String accountId) throws ApiException {
        okhttp3.Call localVarCall = executeValidateBeforeCall(accountId, null);
        Type localVarReturnType = new TypeToken<UnitGetAccountLimitsResponse>(){}.getType();
     ...
     */
    public okhttp3.Call executeAsync(String accountId, final ApiCallback<UnitGetAccountLimitsResponse> _callback) throws ApiException {
