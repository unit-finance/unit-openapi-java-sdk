...
public class GetAtmLocationsListApi {
    ...
    public List<AtmLocation> execute(ExecuteFilterParameter15 filter) throws ApiException {
        ApiResponse<List<AtmLocation>> localVarResp = executeWithHttpInfo(filter);
     ...
     */
    public okhttp3.Call executeAsync(ExecuteFilterParameter15 filter, final ApiCallback<List<AtmLocation>> _callback) throws ApiException {
