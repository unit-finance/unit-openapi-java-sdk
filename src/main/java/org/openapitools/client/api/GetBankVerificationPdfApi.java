...
public class GetBankVerificationPdfApi {
     ...
     */
    public File execute(String accountId) throws ApiException {
        ApiResponse<File> localVarResp = executeWithHttpInfo(accountId);
     ...
     */
    public ApiResponse<File> executeWithHttpInfo(String accountId) throws ApiException {
     ...
     */
    public okhttp3.Call executeAsync(String accountId, final ApiCallback<File> _callback) throws ApiException {
