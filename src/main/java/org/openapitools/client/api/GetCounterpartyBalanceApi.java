...
import org.openapitools.client.model.UnitCounterpartyResponse1;
...
public class GetCounterpartyBalanceApi {
    ...
    public UnitCounterpartyResponse1 execute(String counterpartyId) throws ApiException {
        ApiResponse<UnitCounterpartyResponse1> localVarResp = executeWithHttpInfo(counterpartyId);
    ...
    public ApiResponse<UnitCounterpartyResponse1> executeWithHttpInfo(String counterpartyId) throws ApiException {
        ...
        Type localVarReturnType = new TypeToken<UnitCounterpartyResponse1>(){}.getType();
     ...
     */
    public okhttp3.Call executeAsync(String counterpartyId, final ApiCallback<UnitCounterpartyResponse1> _callback) throws ApiException {
