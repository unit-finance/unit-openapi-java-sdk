...
import org.openapitools.client.model.ReturnCheckPaymentRequest;
...
public class ReturnCheckPaymentApi {
     ...
     */
    public okhttp3.Call executeCall(String checkPaymentId, ReturnCheckPaymentRequest returnCheckPaymentRequest, final ApiCallback _callback) throws ApiException {
        ...
        Object localVarPostBody = returnCheckPaymentRequest;
    ...
    private okhttp3.Call executeValidateBeforeCall(String checkPaymentId, ReturnCheckPaymentRequest returnCheckPaymentRequest, final ApiCallback _callback) throws ApiException {
        ...
        if (returnCheckPaymentRequest == null) {
            throw new ApiException("Missing the required parameter 'returnCheckPaymentRequest' when calling execute(Async)");
        }

        return executeCall(checkPaymentId, returnCheckPaymentRequest, _callback);
    ...
    public UnitCheckPaymentResponse execute(String checkPaymentId, ReturnCheckPaymentRequest returnCheckPaymentRequest) throws ApiException {
        ApiResponse<UnitCheckPaymentResponse> localVarResp = executeWithHttpInfo(checkPaymentId, returnCheckPaymentRequest);
    ...
    public ApiResponse<UnitCheckPaymentResponse> executeWithHttpInfo(String checkPaymentId, ReturnCheckPaymentRequest returnCheckPaymentRequest) throws ApiException {
        okhttp3.Call localVarCall = executeValidateBeforeCall(checkPaymentId, returnCheckPaymentRequest, null);
     ...
     */
    public okhttp3.Call executeAsync(String checkPaymentId, ReturnCheckPaymentRequest returnCheckPaymentRequest, final ApiCallback<UnitCheckPaymentResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = executeValidateBeforeCall(checkPaymentId, returnCheckPaymentRequest, _callback);
        Type localVarReturnType = new TypeToken<UnitCheckPaymentResponse>(){}.getType();
