...
public class UploadAPngDocumentForAnApplicationApi {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public UploadAPngDocumentForAnApplicationApi() {
        this(Configuration.getDefaultApiClient());
    }

    public UploadAPngDocumentForAnApplicationApi(ApiClient apiClient) {
