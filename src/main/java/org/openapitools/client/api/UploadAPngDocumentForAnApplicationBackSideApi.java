...
public class UploadAPngDocumentForAnApplicationBackSideApi {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public UploadAPngDocumentForAnApplicationBackSideApi() {
        this(Configuration.getDefaultApiClient());
    }

    public UploadAPngDocumentForAnApplicationBackSideApi(ApiClient apiClient) {
    ...
    /**
     * Upload a PNG document - Back Side (asynchronously)
     * Upload a PNG file via API - Back Side
     * @param applicationId ID of the application to upload a file to (required)
     * @param documentId ID of the document to upload a file for (required)
     * @param body Upload PNG File - Back Side (required)
