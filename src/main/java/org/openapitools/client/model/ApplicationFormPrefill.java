...
public class ApplicationFormPrefill {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.applicationType, applicationFormPrefill.applicationType) &&
        ...
        Objects.equals(this.jwtSubject, applicationFormPrefill.jwtSubject) &&
  ...
  * @throws IOException if the JSON Element is invalid with respect to ApplicationFormPrefill
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ApplicationFormPrefill.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ApplicationFormPrefill is not found in the empty JSON string", ApplicationFormPrefill.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ApplicationFormPrefill.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ApplicationFormPrefill` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ApplicationFormPrefill.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ApplicationFormPrefill' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ApplicationFormPrefill> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ApplicationFormPrefill.class));

       return (TypeAdapter<T>) new TypeAdapter<ApplicationFormPrefill>() {
           @Override
           public void write(JsonWriter out, ApplicationFormPrefill value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ApplicationFormPrefill read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ApplicationFormPrefill given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ApplicationFormPrefill
  * @throws IOException if the JSON string is invalid with respect to ApplicationFormPrefill
  */
  public static ApplicationFormPrefill fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ApplicationFormPrefill.class);
  }

 /**
  * Convert an instance of ApplicationFormPrefill to an JSON string
  *
  * @return JSON string
  */
