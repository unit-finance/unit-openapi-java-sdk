...
public class CreateAchCounterpartyAttributes {
  ...
  * @throws IOException if the JSON Element is invalid with respect to CreateAchCounterpartyAttributes
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateAchCounterpartyAttributes.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateAchCounterpartyAttributes is not found in the empty JSON string", CreateAchCounterpartyAttributes.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateAchCounterpartyAttributes.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateAchCounterpartyAttributes` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateAchCounterpartyAttributes.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateAchCounterpartyAttributes.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateAchCounterpartyAttributes' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateAchCounterpartyAttributes> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateAchCounterpartyAttributes.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateAchCounterpartyAttributes>() {
           @Override
           public void write(JsonWriter out, CreateAchCounterpartyAttributes value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateAchCounterpartyAttributes read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of CreateAchCounterpartyAttributes given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CreateAchCounterpartyAttributes
  * @throws IOException if the JSON string is invalid with respect to CreateAchCounterpartyAttributes
  */
  public static CreateAchCounterpartyAttributes fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateAchCounterpartyAttributes.class);
  }

 /**
  * Convert an instance of CreateAchCounterpartyAttributes to an JSON string
  *
  * @return JSON string
  */
