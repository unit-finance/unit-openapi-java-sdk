...
public class CreateCardData extends AbstractOpenApiSchema {
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!CreateCardData.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'CreateCardData' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<CreateCardData>() {
                @Override
                public void write(JsonWriter out, CreateCardData value) throws IOException {
                ...
                @Override
                public CreateCardData read(JsonReader in) throws IOException {
                    ...
                    throw new IOException(String.format("Failed deserialization for CreateCardData: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
  ...
  * @throws IOException if the JSON Element is invalid with respect to CreateCardData
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for CreateCardData with oneOf schemas: CreateBusinessCreditCard, CreateBusinessDebitCard, CreateBusinessVirtualCreditCard, CreateBusinessVirtualDebitCard, CreateIndividualDebitCard, CreateIndividualVirtualDebitCard. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
    }
  }

 /**
  * Create an instance of CreateCardData given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CreateCardData
  * @throws IOException if the JSON string is invalid with respect to CreateCardData
  */
  public static CreateCardData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateCardData.class);
  }

 /**
  * Convert an instance of CreateCardData to an JSON string
  *
  * @return JSON string
  */
