...
public class CreatePaymentData extends AbstractOpenApiSchema {
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!CreatePaymentData.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'CreatePaymentData' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<CreatePaymentData>() {
                @Override
                public void write(JsonWriter out, CreatePaymentData value) throws IOException {
                ...
                @Override
                public CreatePaymentData read(JsonReader in) throws IOException {
                    ...
                    throw new IOException(String.format("Failed deserialization for CreatePaymentData: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
  ...
  * @throws IOException if the JSON Element is invalid with respect to CreatePaymentData
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for CreatePaymentData with oneOf schemas: CreateAchPayment, CreateAchPaymentCounterparty, CreateAchPaymentPlaid, CreateBillPayment, CreateBookPayment, CreatePushToCardPayment, CreateWirePayment. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
    }
  }

 /**
  * Create an instance of CreatePaymentData given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CreatePaymentData
  * @throws IOException if the JSON string is invalid with respect to CreatePaymentData
  */
  public static CreatePaymentData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreatePaymentData.class);
  }

 /**
  * Convert an instance of CreatePaymentData to an JSON string
  *
  * @return JSON string
  */
