  ...
  */
  ...
  public List<Pair> toParams(){
    ...
    if(this.accountNumber != null){
      params.add(new Pair("filter[accountNumber]", this.accountNumber));
    }
    ...
    if(this.routingNumber != null){
      params.add(new Pair("filter[routingNumber]", this.routingNumber));
    }

    if(this.permissions != null){
      int i=0;
      for (PermissionsEnum p:this.permissions) {
        params.add(new Pair(String.format("filter[permissions][%s]", i), p.getValue()));
        i++;
      }
    }
