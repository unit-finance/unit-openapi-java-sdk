...
public class PurchaseTransactionAllOfAttributes {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.createdAt, purchaseTransactionAllOfAttributes.createdAt) &&
        ...
        Objects.equals(this.interchange, purchaseTransactionAllOfAttributes.interchange) &&
        ...
        Objects.equals(this.internationalServiceFee, purchaseTransactionAllOfAttributes.internationalServiceFee) &&
  ...
  static {
    ...
    openapiRequiredFields.add("ecommerce");
    openapiRequiredFields.add("cardPresent");
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to PurchaseTransactionAllOfAttributes
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PurchaseTransactionAllOfAttributes.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PurchaseTransactionAllOfAttributes is not found in the empty JSON string", PurchaseTransactionAllOfAttributes.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PurchaseTransactionAllOfAttributes.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PurchaseTransactionAllOfAttributes` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PurchaseTransactionAllOfAttributes.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PurchaseTransactionAllOfAttributes.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PurchaseTransactionAllOfAttributes' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PurchaseTransactionAllOfAttributes> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PurchaseTransactionAllOfAttributes.class));

       return (TypeAdapter<T>) new TypeAdapter<PurchaseTransactionAllOfAttributes>() {
           @Override
           public void write(JsonWriter out, PurchaseTransactionAllOfAttributes value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PurchaseTransactionAllOfAttributes read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of PurchaseTransactionAllOfAttributes given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PurchaseTransactionAllOfAttributes
  * @throws IOException if the JSON string is invalid with respect to PurchaseTransactionAllOfAttributes
  */
  public static PurchaseTransactionAllOfAttributes fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PurchaseTransactionAllOfAttributes.class);
  }

 /**
  * Convert an instance of PurchaseTransactionAllOfAttributes to an JSON string
  *
  * @return JSON string
  */
