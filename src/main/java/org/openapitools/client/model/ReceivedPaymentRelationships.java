...
public class ReceivedPaymentRelationships {
  ...
  **/
   ...
   * @return the ReceivedPaymentRelationships instance itself
   */
  ...
  @Override
  public int hashCode() {
    return Objects.hash(account, customer, receivePaymentTransaction, paymentAdvanceTransaction, repayPaymentAdvanceTransaction, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ReceivedPaymentRelationships>() {
           ...
           public ReceivedPaymentRelationships read(JsonReader in) throws IOException {
             ...
             ReceivedPaymentRelationships instance = thisAdapter.fromJsonTree(jsonObj);
