...
public class ApproveAuthorizationRequestApi {
  ...
  public UnitAuthorizationRequestResponse execute(String authorizationId, ApproveAuthorizationRequest approveAuthorizationRequest) throws ApiException {
    ApiResponse<UnitAuthorizationRequestResponse> localVarResponse = executeWithHttpInfo(authorizationId, approveAuthorizationRequest);
  ...
  public ApiResponse<UnitAuthorizationRequestResponse> executeWithHttpInfo(String authorizationId, ApproveAuthorizationRequest approveAuthorizationRequest) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = executeRequestBuilder(authorizationId, approveAuthorizationRequest);
    try {
  ...
  private HttpRequest.Builder executeRequestBuilder(String authorizationId, ApproveAuthorizationRequest approveAuthorizationRequest) throws ApiException {
    ...
    if (approveAuthorizationRequest == null) {
      throw new ApiException(400, "Missing the required parameter 'approveAuthorizationRequest' when calling execute");
    }
