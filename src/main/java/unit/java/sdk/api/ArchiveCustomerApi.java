...
public class ArchiveCustomerApi {
  ...
  public UnitCustomerResponse execute(String customerId, ArchiveCustomerRequest archiveCustomerRequest) throws ApiException {
    ApiResponse<UnitCustomerResponse> localVarResponse = executeWithHttpInfo(customerId, archiveCustomerRequest);
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<UnitCustomerResponse> executeWithHttpInfo(String customerId, ArchiveCustomerRequest archiveCustomerRequest) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = executeRequestBuilder(customerId, archiveCustomerRequest);
    try {
  ...
  private HttpRequest.Builder executeRequestBuilder(String customerId, ArchiveCustomerRequest archiveCustomerRequest) throws ApiException {
    ...
    if (archiveCustomerRequest == null) {
      throw new ApiException(400, "Missing the required parameter 'archiveCustomerRequest' when calling execute");
    }
