...
public class CancelPaymentApi {
   ...
   */
  public UnitPaymentResponse execute(String paymentId) throws ApiException {
    ApiResponse<UnitPaymentResponse> localVarResponse = executeWithHttpInfo(paymentId);
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<UnitPaymentResponse> executeWithHttpInfo(String paymentId) throws ApiException {
