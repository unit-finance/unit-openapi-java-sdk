...
public class CloseAnAccountApi {
  ...
  public UnitAccountResponse execute(String accountId, CloseAccountRequest closeAccountRequest) throws ApiException {
    ApiResponse<UnitAccountResponse> localVarResponse = executeWithHttpInfo(accountId, closeAccountRequest);
  ...
  public ApiResponse<UnitAccountResponse> executeWithHttpInfo(String accountId, CloseAccountRequest closeAccountRequest) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = executeRequestBuilder(accountId, closeAccountRequest);
    try {
  ...
  private HttpRequest.Builder executeRequestBuilder(String accountId, CloseAccountRequest closeAccountRequest) throws ApiException {
    ...
    if (closeAccountRequest == null) {
      throw new ApiException(400, "Missing the required parameter 'closeAccountRequest' when calling execute");
    }
