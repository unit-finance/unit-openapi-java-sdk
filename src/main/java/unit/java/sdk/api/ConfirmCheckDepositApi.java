...
public class ConfirmCheckDepositApi {
  ...
  public UnitCheckDepositResponse execute(String checkDepositId) throws ApiException {
    ApiResponse<UnitCheckDepositResponse> localVarResponse = executeWithHttpInfo(checkDepositId);
  ...
  private HttpRequest.Builder executeRequestBuilder(String checkDepositId) throws ApiException {
