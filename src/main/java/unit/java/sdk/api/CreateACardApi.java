...
import unit.java.sdk.model.CreateCard;
...
public class CreateACardApi {
  ...
  public UnitCardResponse execute(CreateCard createCard) throws ApiException {
    ApiResponse<UnitCardResponse> localVarResponse = executeWithHttpInfo(createCard);
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<UnitCardResponse> executeWithHttpInfo(CreateCard createCard) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = executeRequestBuilder(createCard);
    try {
  ...
  private HttpRequest.Builder executeRequestBuilder(CreateCard createCard) throws ApiException {
    // verify the required parameter 'createCard' is set
    if (createCard == null) {
      throw new ApiException(400, "Missing the required parameter 'createCard' when calling execute");
    }
    ...
    try {
      byte[] localVarPostBody = memberVarObjectMapper.writeValueAsBytes(createCard);
