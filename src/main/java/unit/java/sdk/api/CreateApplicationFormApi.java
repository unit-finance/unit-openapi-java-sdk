...
import unit.java.sdk.model.CreateApplicationForm;
...
public class CreateApplicationFormApi {
  ...
  public UnitApplicationFormResponse execute(CreateApplicationForm createApplicationForm) throws ApiException {
    ApiResponse<UnitApplicationFormResponse> localVarResponse = executeWithHttpInfo(createApplicationForm);
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<UnitApplicationFormResponse> executeWithHttpInfo(CreateApplicationForm createApplicationForm) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = executeRequestBuilder(createApplicationForm);
    try {
  ...
  private HttpRequest.Builder executeRequestBuilder(CreateApplicationForm createApplicationForm) throws ApiException {
    // verify the required parameter 'createApplicationForm' is set
    if (createApplicationForm == null) {
      throw new ApiException(400, "Missing the required parameter 'createApplicationForm' when calling execute");
    }
    ...
    try {
      byte[] localVarPostBody = memberVarObjectMapper.writeValueAsBytes(createApplicationForm);
