...
public class CreateCheckDepositApi {
  ...
  public UnitCheckDepositResponse execute(CreateCheckDeposit createCheckDeposit) throws ApiException {
    ApiResponse<UnitCheckDepositResponse> localVarResponse = executeWithHttpInfo(createCheckDeposit);
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<UnitCheckDepositResponse> executeWithHttpInfo(CreateCheckDeposit createCheckDeposit) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = executeRequestBuilder(createCheckDeposit);
    try {
  ...
  private HttpRequest.Builder executeRequestBuilder(CreateCheckDeposit createCheckDeposit) throws ApiException {
    // verify the required parameter 'createCheckDeposit' is set
    if (createCheckDeposit == null) {
      throw new ApiException(400, "Missing the required parameter 'createCheckDeposit' when calling execute");
    }
    ...
    try {
      byte[] localVarPostBody = memberVarObjectMapper.writeValueAsBytes(createCheckDeposit);
