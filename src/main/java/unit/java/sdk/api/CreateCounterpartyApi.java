...
public class CreateCounterpartyApi {
  ...
  public UnitCounterpartyResponse execute(CreateCounterparty createCounterparty) throws ApiException {
    ApiResponse<UnitCounterpartyResponse> localVarResponse = executeWithHttpInfo(createCounterparty);
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<UnitCounterpartyResponse> executeWithHttpInfo(CreateCounterparty createCounterparty) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = executeRequestBuilder(createCounterparty);
    try {
  ...
  private HttpRequest.Builder executeRequestBuilder(CreateCounterparty createCounterparty) throws ApiException {
    // verify the required parameter 'createCounterparty' is set
    if (createCounterparty == null) {
      throw new ApiException(400, "Missing the required parameter 'createCounterparty' when calling execute");
    }
    ...
    try {
      byte[] localVarPostBody = memberVarObjectMapper.writeValueAsBytes(createCounterparty);
