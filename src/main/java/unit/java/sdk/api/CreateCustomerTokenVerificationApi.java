...
import unit.java.sdk.model.CreateCustomerTokenVerification;
...
public class CreateCustomerTokenVerificationApi {
  ...
  public UnitCustomerTokenVerificationResponse execute(String customerId, CreateCustomerTokenVerification createCustomerTokenVerification) throws ApiException {
    ApiResponse<UnitCustomerTokenVerificationResponse> localVarResponse = executeWithHttpInfo(customerId, createCustomerTokenVerification);
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<UnitCustomerTokenVerificationResponse> executeWithHttpInfo(String customerId, CreateCustomerTokenVerification createCustomerTokenVerification) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = executeRequestBuilder(customerId, createCustomerTokenVerification);
    try {
  ...
  private HttpRequest.Builder executeRequestBuilder(String customerId, CreateCustomerTokenVerification createCustomerTokenVerification) throws ApiException {
    ...
    if (createCustomerTokenVerification == null) {
      throw new ApiException(400, "Missing the required parameter 'createCustomerTokenVerification' when calling execute");
    }
    ...
    try {
      byte[] localVarPostBody = memberVarObjectMapper.writeValueAsBytes(createCustomerTokenVerification);
