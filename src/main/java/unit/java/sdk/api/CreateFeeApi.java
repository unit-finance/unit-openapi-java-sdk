...
public class CreateFeeApi {
  ...
  public UnitFeeResponse execute(Object body) throws ApiException {
    ApiResponse<UnitFeeResponse> localVarResponse = executeWithHttpInfo(body);
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<UnitFeeResponse> executeWithHttpInfo(Object body) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = executeRequestBuilder(body);
    try {
  ...
  private HttpRequest.Builder executeRequestBuilder(Object body) throws ApiException {
