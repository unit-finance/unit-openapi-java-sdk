...
public class CreateFeeApi {
   ...
   */
  public UnitFeeResponse execute(CreateFeeRequest createFeeRequest) throws ApiException {
    ApiResponse<UnitFeeResponse> localVarResponse = executeWithHttpInfo(createFeeRequest);
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<UnitFeeResponse> executeWithHttpInfo(CreateFeeRequest createFeeRequest) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = executeRequestBuilder(createFeeRequest);
    try {
  ...
  private HttpRequest.Builder executeRequestBuilder(CreateFeeRequest createFeeRequest) throws ApiException {
    // verify the required parameter 'createFeeRequest' is set
    if (createFeeRequest == null) {
      throw new ApiException(400, "Missing the required parameter 'createFeeRequest' when calling execute");
    }
