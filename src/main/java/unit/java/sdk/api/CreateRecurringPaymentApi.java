...
import unit.java.sdk.model.CreateRecurringPayment;
...
public class CreateRecurringPaymentApi {
  ...
  public UnitRecurringPaymentResponse execute(CreateRecurringPayment createRecurringPayment) throws ApiException {
    ApiResponse<UnitRecurringPaymentResponse> localVarResponse = executeWithHttpInfo(createRecurringPayment);
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<UnitRecurringPaymentResponse> executeWithHttpInfo(CreateRecurringPayment createRecurringPayment) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = executeRequestBuilder(createRecurringPayment);
    try {
  ...
  private HttpRequest.Builder executeRequestBuilder(CreateRecurringPayment createRecurringPayment) throws ApiException {
    // verify the required parameter 'createRecurringPayment' is set
    if (createRecurringPayment == null) {
      throw new ApiException(400, "Missing the required parameter 'createRecurringPayment' when calling execute");
    }
    ...
    try {
      byte[] localVarPostBody = memberVarObjectMapper.writeValueAsBytes(createRecurringPayment);
