...
public class DeclineAuthorizationRequestApi {
  ...
  public DeclineAuthorizationRequestApi() {
    this(new ApiClient());
  }

  public DeclineAuthorizationRequestApi(ApiClient apiClient) {
  ...
  public UnitAuthorizationRequestResponse execute(String authorizationId, DeclineAuthorizationRequest declineAuthorizationRequest) throws ApiException {
    ApiResponse<UnitAuthorizationRequestResponse> localVarResponse = executeWithHttpInfo(authorizationId, declineAuthorizationRequest);
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<UnitAuthorizationRequestResponse> executeWithHttpInfo(String authorizationId, DeclineAuthorizationRequest declineAuthorizationRequest) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = executeRequestBuilder(authorizationId, declineAuthorizationRequest);
    try {
  ...
  private HttpRequest.Builder executeRequestBuilder(String authorizationId, DeclineAuthorizationRequest declineAuthorizationRequest) throws ApiException {
    // verify the required parameter 'authorizationId' is set
    if (authorizationId == null) {
      throw new ApiException(400, "Missing the required parameter 'authorizationId' when calling execute");
    }
    // verify the required parameter 'declineAuthorizationRequest' is set
    if (declineAuthorizationRequest == null) {
      throw new ApiException(400, "Missing the required parameter 'declineAuthorizationRequest' when calling execute");
    }
