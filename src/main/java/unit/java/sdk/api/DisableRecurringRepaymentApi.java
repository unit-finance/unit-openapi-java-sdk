...
public class DisableRecurringRepaymentApi {
  ...
  public DisableRecurringRepaymentApi() {
    this(new ApiClient());
  }

  public DisableRecurringRepaymentApi(ApiClient apiClient) {
   ...
   */
  public UnitRecurringRepaymentResponse execute(String recurringRepaymentId, String include) throws ApiException {
    ApiResponse<UnitRecurringRepaymentResponse> localVarResponse = executeWithHttpInfo(recurringRepaymentId, include);
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<UnitRecurringRepaymentResponse> executeWithHttpInfo(String recurringRepaymentId, String include) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = executeRequestBuilder(recurringRepaymentId, include);
    try {
  ...
  private HttpRequest.Builder executeRequestBuilder(String recurringRepaymentId, String include) throws ApiException {
    // verify the required parameter 'recurringRepaymentId' is set
    if (recurringRepaymentId == null) {
      throw new ApiException(400, "Missing the required parameter 'recurringRepaymentId' when calling execute");
    }
