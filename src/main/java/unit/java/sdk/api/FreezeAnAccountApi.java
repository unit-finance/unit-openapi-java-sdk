...
public class FreezeAnAccountApi {
  ...
  public UnitAccountResponse execute(String accountId, FreezeAccountRequest freezeAccountRequest) throws ApiException {
    ApiResponse<UnitAccountResponse> localVarResponse = executeWithHttpInfo(accountId, freezeAccountRequest);
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<UnitAccountResponse> executeWithHttpInfo(String accountId, FreezeAccountRequest freezeAccountRequest) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = executeRequestBuilder(accountId, freezeAccountRequest);
    try {
  ...
  private HttpRequest.Builder executeRequestBuilder(String accountId, FreezeAccountRequest freezeAccountRequest) throws ApiException {
    ...
    if (freezeAccountRequest == null) {
      throw new ApiException(400, "Missing the required parameter 'freezeAccountRequest' when calling execute");
    }
