...
public class GetAccountApi {
  ...
  public UnitAccountResponseWithIncluded execute(String accountId, String include) throws ApiException {
    ApiResponse<UnitAccountResponseWithIncluded> localVarResponse = executeWithHttpInfo(accountId, include);
  ...
  public ApiResponse<UnitAccountResponseWithIncluded> executeWithHttpInfo(String accountId, String include) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = executeRequestBuilder(accountId, include);
    try {
  ...
  private HttpRequest.Builder executeRequestBuilder(String accountId, String include) throws ApiException {
