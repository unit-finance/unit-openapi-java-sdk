...
public class GetApplicationApi {
  ...
  public UnitApplicationResponseWithIncluded execute(String applicationId, String included) throws ApiException {
    ApiResponse<UnitApplicationResponseWithIncluded> localVarResponse = executeWithHttpInfo(applicationId, included);
  ...
  public ApiResponse<UnitApplicationResponseWithIncluded> executeWithHttpInfo(String applicationId, String included) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = executeRequestBuilder(applicationId, included);
    try {
  ...
  private HttpRequest.Builder executeRequestBuilder(String applicationId, String included) throws ApiException {
