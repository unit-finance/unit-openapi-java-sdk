...
public class GetAtmLocationsListApi {
   ...
   */
  public List<AtmLocation> execute(ExecuteFilterParameter15 filter) throws ApiException {
    ApiResponse<List<AtmLocation>> localVarResponse = executeWithHttpInfo(filter);
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<List<AtmLocation>> executeWithHttpInfo(ExecuteFilterParameter15 filter) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = executeRequestBuilder(filter);
    try {
  ...
  private HttpRequest.Builder executeRequestBuilder(ExecuteFilterParameter15 filter) throws ApiException {
