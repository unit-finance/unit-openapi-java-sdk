...
public class GetAuthorizationApi {
  ...
  public UnitAuthorizationResponse execute(String authorizationId, Boolean includeNoneAuthorized) throws ApiException {
    ApiResponse<UnitAuthorizationResponse> localVarResponse = executeWithHttpInfo(authorizationId, includeNoneAuthorized);
  ...
  public ApiResponse<UnitAuthorizationResponse> executeWithHttpInfo(String authorizationId, Boolean includeNoneAuthorized) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = executeRequestBuilder(authorizationId, includeNoneAuthorized);
    try {
  ...
  private HttpRequest.Builder executeRequestBuilder(String authorizationId, Boolean includeNoneAuthorized) throws ApiException {
