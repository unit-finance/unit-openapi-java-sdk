...
public class GetAuthorizationRequestApi {
  ...
  public UnitAuthorizationRequestsResponse execute(String authorizationId) throws ApiException {
    ApiResponse<UnitAuthorizationRequestsResponse> localVarResponse = executeWithHttpInfo(authorizationId);
  ...
  public ApiResponse<UnitAuthorizationRequestsResponse> executeWithHttpInfo(String authorizationId) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = executeRequestBuilder(authorizationId);
    try {
  ...
  private HttpRequest.Builder executeRequestBuilder(String authorizationId) throws ApiException {
