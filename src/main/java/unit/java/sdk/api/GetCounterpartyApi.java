...
public class GetCounterpartyApi {
  ...
  public UnitCounterpartyResponse execute(String counterpartyId, String included) throws ApiException {
    ApiResponse<UnitCounterpartyResponse> localVarResponse = executeWithHttpInfo(counterpartyId, included);
  ...
  public ApiResponse<UnitCounterpartyResponse> executeWithHttpInfo(String counterpartyId, String included) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = executeRequestBuilder(counterpartyId, included);
    try {
  ...
  private HttpRequest.Builder executeRequestBuilder(String counterpartyId, String included) throws ApiException {
