...
public class GetDisputeApi {
  ...
  public UnitDisputeResponse execute(String disputeId) throws ApiException {
    ApiResponse<UnitDisputeResponse> localVarResponse = executeWithHttpInfo(disputeId);
  ...
  public ApiResponse<UnitDisputeResponse> executeWithHttpInfo(String disputeId) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = executeRequestBuilder(disputeId);
    try {
  ...
  private HttpRequest.Builder executeRequestBuilder(String disputeId) throws ApiException {
    // verify the required parameter 'disputeId' is set
    if (disputeId == null) {
      throw new ApiException(400, "Missing the required parameter 'disputeId' when calling execute");
    }
