...
public class GetListAccountEndOfDayBalancesHistoryApi {
  ...
  public UnitGetAccountEndOfDayListResponse execute() throws ApiException {
    ApiResponse<UnitGetAccountEndOfDayListResponse> localVarResponse = executeWithHttpInfo();
  ...
  public ApiResponse<UnitGetAccountEndOfDayListResponse> executeWithHttpInfo() throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = executeRequestBuilder();
    try {
  ...
  private HttpRequest.Builder executeRequestBuilder() throws ApiException {
