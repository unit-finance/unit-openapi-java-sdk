...
public class GetListAccountsApi {
  ...
  public UnitAccountsListResponse execute(ListPageParametersObject page, ExecuteFilterParameter2 filter, String include) throws ApiException {
    ApiResponse<UnitAccountsListResponse> localVarResponse = executeWithHttpInfo(page, filter, include);
  ...
  public ApiResponse<UnitAccountsListResponse> executeWithHttpInfo(ListPageParametersObject page, ExecuteFilterParameter2 filter, String include) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = executeRequestBuilder(page, filter, include);
    try {
  ...
  private HttpRequest.Builder executeRequestBuilder(ListPageParametersObject page, ExecuteFilterParameter2 filter, String include) throws ApiException {
