...
import unit.java.sdk.model.ExecuteFilterParameter1;
...
public class GetListApplicationFormsApi {
  ...
  public UnitApplicationFormsListResponse execute(ListPageParametersObject page, ExecuteFilterParameter1 filter, String sort) throws ApiException {
    ApiResponse<UnitApplicationFormsListResponse> localVarResponse = executeWithHttpInfo(page, filter, sort);
  ...
  private HttpRequest.Builder executeRequestBuilder(ListPageParametersObject page, ExecuteFilterParameter1 filter, String sort) throws ApiException {
