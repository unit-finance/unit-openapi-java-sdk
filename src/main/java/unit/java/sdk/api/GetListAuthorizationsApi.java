...
public class GetListAuthorizationsApi {
  ...
  public UnitListAuthorizationsResponse execute(ListPageParametersObject page, ExecuteFilterParameter8 filter, String sort) throws ApiException {
    ApiResponse<UnitListAuthorizationsResponse> localVarResponse = executeWithHttpInfo(page, filter, sort);
  ...
  private HttpRequest.Builder executeRequestBuilder(ListPageParametersObject page, ExecuteFilterParameter8 filter, String sort) throws ApiException {
