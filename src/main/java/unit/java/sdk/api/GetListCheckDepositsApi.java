...
import unit.java.sdk.model.ExecuteFilterParameter13;
...
public class GetListCheckDepositsApi {
  ...
  public UnitListCheckDepositsResponse execute(ListPageParametersObject page, ExecuteFilterParameter13 filter, String sort, String include) throws ApiException {
    ApiResponse<UnitListCheckDepositsResponse> localVarResponse = executeWithHttpInfo(page, filter, sort, include);
  ...
  private HttpRequest.Builder executeRequestBuilder(ListPageParametersObject page, ExecuteFilterParameter13 filter, String sort, String include) throws ApiException {
