...
import unit.java.sdk.model.ExecuteFilterParameter5;
...
public class GetListCounterpartiesApi {
  ...
  public UnitCounterpartiesListResponse execute(ListPageParametersObject page, ExecuteFilterParameter5 filter, String sort) throws ApiException {
    ApiResponse<UnitCounterpartiesListResponse> localVarResponse = executeWithHttpInfo(page, filter, sort);
  ...
  private HttpRequest.Builder executeRequestBuilder(ListPageParametersObject page, ExecuteFilterParameter5 filter, String sort) throws ApiException {
