...
public class GetListCustomersApi {
  ...
  public UnitCustomersListResponse execute(ListPageParametersObject page, ExecuteFilterParameter3 filter, String sort) throws ApiException {
    ApiResponse<UnitCustomersListResponse> localVarResponse = executeWithHttpInfo(page, filter, sort);
  ...
  private HttpRequest.Builder executeRequestBuilder(ListPageParametersObject page, ExecuteFilterParameter3 filter, String sort) throws ApiException {
