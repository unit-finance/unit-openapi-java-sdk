...
public class GetListDisputesApi {
  ...
  public List<Dispute> execute(ListPageParametersObject page, ExecuteFilterParameter17 filter) throws ApiException {
    ApiResponse<List<Dispute>> localVarResponse = executeWithHttpInfo(page, filter);
  ...
  private HttpRequest.Builder executeRequestBuilder(ListPageParametersObject page, ExecuteFilterParameter17 filter) throws ApiException {
