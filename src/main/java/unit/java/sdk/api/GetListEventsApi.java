...
import unit.java.sdk.model.ExecuteFilterParameter12;
...
public class GetListEventsApi {
  ...
  public UnitEventListResponse execute(ListPageParametersObject page, ExecuteFilterParameter12 filter) throws ApiException {
    ApiResponse<UnitEventListResponse> localVarResponse = executeWithHttpInfo(page, filter);
  ...
  private HttpRequest.Builder executeRequestBuilder(ListPageParametersObject page, ExecuteFilterParameter12 filter) throws ApiException {
