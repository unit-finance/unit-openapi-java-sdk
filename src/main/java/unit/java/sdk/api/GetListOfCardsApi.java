...
public class GetListOfCardsApi {
  ...
  public UnitCardResponseCardsList execute(ListPageParametersObject page, ExecuteFilterParameter7 filter, String include, String sort) throws ApiException {
    ApiResponse<UnitCardResponseCardsList> localVarResponse = executeWithHttpInfo(page, filter, include, sort);
  ...
  public ApiResponse<UnitCardResponseCardsList> executeWithHttpInfo(ListPageParametersObject page, ExecuteFilterParameter7 filter, String include, String sort) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = executeRequestBuilder(page, filter, include, sort);
    try {
  ...
  private HttpRequest.Builder executeRequestBuilder(ListPageParametersObject page, ExecuteFilterParameter7 filter, String include, String sort) throws ApiException {
