...
public class GetListOfDocumentsApi {
  ...
  public UnitListDocumentsResponse execute(String applicationId) throws ApiException {
    ApiResponse<UnitListDocumentsResponse> localVarResponse = executeWithHttpInfo(applicationId);
  ...
  public ApiResponse<UnitListDocumentsResponse> executeWithHttpInfo(String applicationId) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = executeRequestBuilder(applicationId);
    try {
