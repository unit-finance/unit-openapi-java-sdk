...
public class GetListOrgApiTokensApi {
  ...
  public UnitOrgApiTokensListResponse execute(String userId) throws ApiException {
    ApiResponse<UnitOrgApiTokensListResponse> localVarResponse = executeWithHttpInfo(userId);
  ...
  public ApiResponse<UnitOrgApiTokensListResponse> executeWithHttpInfo(String userId) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = executeRequestBuilder(userId);
    try {
  ...
  private HttpRequest.Builder executeRequestBuilder(String userId) throws ApiException {
