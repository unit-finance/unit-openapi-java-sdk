...
public class GetListPaymentsApi {
  ...
  public UnitPaymentsListResponse execute(ListPageParametersObject page, ExecuteFilterParameter4 filter, String include, String sort) throws ApiException {
    ApiResponse<UnitPaymentsListResponse> localVarResponse = executeWithHttpInfo(page, filter, include, sort);
  ...
  private HttpRequest.Builder executeRequestBuilder(ListPageParametersObject page, ExecuteFilterParameter4 filter, String include, String sort) throws ApiException {
