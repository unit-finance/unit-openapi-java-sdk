...
import unit.java.sdk.model.ExecuteFilterParameter6;
...
public class GetListRecurringPaymentsApi {
  ...
  public UnitRecurringPaymentListResponse execute(ListPageParametersObject page, ExecuteFilterParameter6 filter, String sort) throws ApiException {
    ApiResponse<UnitRecurringPaymentListResponse> localVarResponse = executeWithHttpInfo(page, filter, sort);
  ...
  private HttpRequest.Builder executeRequestBuilder(ListPageParametersObject page, ExecuteFilterParameter6 filter, String sort) throws ApiException {
