...
public class GetListRecurringRepaymentsApi {
  ...
  public GetListRecurringRepaymentsApi() {
    this(new ApiClient());
  }

  public GetListRecurringRepaymentsApi(ApiClient apiClient) {
   ...
   */
  public UnitRecurringRepaymentsListResponse execute(ListPageParametersObject page, ExecuteFilterParameter19 filter, String sort) throws ApiException {
    ApiResponse<UnitRecurringRepaymentsListResponse> localVarResponse = executeWithHttpInfo(page, filter, sort);
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<UnitRecurringRepaymentsListResponse> executeWithHttpInfo(ListPageParametersObject page, ExecuteFilterParameter19 filter, String sort) throws ApiException {
  ...
  private HttpRequest.Builder executeRequestBuilder(ListPageParametersObject page, ExecuteFilterParameter19 filter, String sort) throws ApiException {
