...
public class GetListStatementsApi {
  ...
  public UnitStatementsResponse execute(ListPageParametersObject page, ExecuteFilterParameter10 filter, String sort) throws ApiException {
    ApiResponse<UnitStatementsResponse> localVarResponse = executeWithHttpInfo(page, filter, sort);
  ...
  private HttpRequest.Builder executeRequestBuilder(ListPageParametersObject page, ExecuteFilterParameter10 filter, String sort) throws ApiException {
