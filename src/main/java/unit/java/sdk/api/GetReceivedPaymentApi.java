...
public class GetReceivedPaymentApi {
  ...
  public UnitReceivedPaymentResponseWithIncluded execute(String paymentId, String included) throws ApiException {
    ApiResponse<UnitReceivedPaymentResponseWithIncluded> localVarResponse = executeWithHttpInfo(paymentId, included);
  ...
  public ApiResponse<UnitReceivedPaymentResponseWithIncluded> executeWithHttpInfo(String paymentId, String included) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = executeRequestBuilder(paymentId, included);
    try {
  ...
  private HttpRequest.Builder executeRequestBuilder(String paymentId, String included) throws ApiException {
