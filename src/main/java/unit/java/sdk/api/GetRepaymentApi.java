...
public class GetRepaymentApi {
  ...
  public UnitRepaymentResponse execute(String repaymentId, String include) throws ApiException {
    ApiResponse<UnitRepaymentResponse> localVarResponse = executeWithHttpInfo(repaymentId, include);
  ...
  public ApiResponse<UnitRepaymentResponse> executeWithHttpInfo(String repaymentId, String include) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = executeRequestBuilder(repaymentId, include);
    try {
  ...
  private HttpRequest.Builder executeRequestBuilder(String repaymentId, String include) throws ApiException {
    // verify the required parameter 'repaymentId' is set
    if (repaymentId == null) {
      throw new ApiException(400, "Missing the required parameter 'repaymentId' when calling execute");
    }
