...
public class GetRewardApi {
  ...
  public UnitRewardResponse execute(String rewardId) throws ApiException {
    ApiResponse<UnitRewardResponse> localVarResponse = executeWithHttpInfo(rewardId);
  ...
  public ApiResponse<UnitRewardResponse> executeWithHttpInfo(String rewardId) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = executeRequestBuilder(rewardId);
    try {
  ...
  private HttpRequest.Builder executeRequestBuilder(String rewardId) throws ApiException {
    // verify the required parameter 'rewardId' is set
    if (rewardId == null) {
      throw new ApiException(400, "Missing the required parameter 'rewardId' when calling execute");
    }
