...
public class RepaymentInformationApi {
  ...
  public UnitRepaymentInformationResponse execute(String accountId) throws ApiException {
    ApiResponse<UnitRepaymentInformationResponse> localVarResponse = executeWithHttpInfo(accountId);
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<UnitRepaymentInformationResponse> executeWithHttpInfo(String accountId) throws ApiException {
