...
public class UnitApi {
   ...
   * Get list of missing due diligence fields by application id
   * @param applicationId ID of the application to get missing fields for (required)
   * @return UnitApplicationMissingFieldsResponse
   * @throws ApiException if fails to make API call
   */
  public UnitApplicationMissingFieldsResponse getApplicationMissingFields(String applicationId) throws ApiException {
    ApiResponse<UnitApplicationMissingFieldsResponse> localVarResponse = getApplicationMissingFieldsWithHttpInfo(applicationId);
    return localVarResponse.getData();
  }
   ...
   * Get list of missing due diligence fields by application id
   * @param applicationId ID of the application to get missing fields for (required)
   * @return ApiResponse&lt;UnitApplicationMissingFieldsResponse&gt;
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<UnitApplicationMissingFieldsResponse> getApplicationMissingFieldsWithHttpInfo(String applicationId) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = getApplicationMissingFieldsRequestBuilder(applicationId);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
      ...
      try {
        if (localVarResponse.statusCode()/ 100 != 2) {
          throw getApiException("getApplicationMissingFields", localVarResponse);
        }
        return new ApiResponse<UnitApplicationMissingFieldsResponse>(
          localVarResponse.statusCode(),
          localVarResponse.headers().map(),
          localVarResponse.body() == null ? null : memberVarObjectMapper.readValue(localVarResponse.body(), new TypeReference<UnitApplicationMissingFieldsResponse>() {}) // closes the InputStream
        );
      } finally {
      }
    } catch (IOException e) {
  ...
  private HttpRequest.Builder getApplicationMissingFieldsRequestBuilder(String applicationId) throws ApiException {
    // verify the required parameter 'applicationId' is set
    if (applicationId == null) {
      throw new ApiException(400, "Missing the required parameter 'applicationId' when calling getApplicationMissingFields");
    }

    HttpRequest.Builder localVarRequestBuilder = HttpRequest.newBuilder();

    String localVarPath = "/applications/{applicationId}/missing-fields"
        .replace("{applicationId}", ApiClient.urlEncode(applicationId.toString()));
