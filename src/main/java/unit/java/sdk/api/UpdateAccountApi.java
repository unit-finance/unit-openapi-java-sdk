...
public class UpdateAccountApi {
  ...
  public UnitAccountResponse execute(String accountId, PatchAccount patchAccount) throws ApiException {
    ApiResponse<UnitAccountResponse> localVarResponse = executeWithHttpInfo(accountId, patchAccount);
  ...
  public ApiResponse<UnitAccountResponse> executeWithHttpInfo(String accountId, PatchAccount patchAccount) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = executeRequestBuilder(accountId, patchAccount);
    try {
  ...
  private HttpRequest.Builder executeRequestBuilder(String accountId, PatchAccount patchAccount) throws ApiException {
    ...
    if (patchAccount == null) {
      throw new ApiException(400, "Missing the required parameter 'patchAccount' when calling execute");
    }
    ...
    try {
      byte[] localVarPostBody = memberVarObjectMapper.writeValueAsBytes(patchAccount);
