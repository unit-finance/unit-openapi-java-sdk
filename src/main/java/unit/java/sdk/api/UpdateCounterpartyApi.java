...
public class UpdateCounterpartyApi {
  ...
  public UnitCounterpartyResponse execute(String counterpartyId, UpdateCounterparty updateCounterparty) throws ApiException {
    ApiResponse<UnitCounterpartyResponse> localVarResponse = executeWithHttpInfo(counterpartyId, updateCounterparty);
  ...
  public ApiResponse<UnitCounterpartyResponse> executeWithHttpInfo(String counterpartyId, UpdateCounterparty updateCounterparty) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = executeRequestBuilder(counterpartyId, updateCounterparty);
    try {
  ...
  private HttpRequest.Builder executeRequestBuilder(String counterpartyId, UpdateCounterparty updateCounterparty) throws ApiException {
    ...
    if (updateCounterparty == null) {
      throw new ApiException(400, "Missing the required parameter 'updateCounterparty' when calling execute");
    }
    ...
    try {
      byte[] localVarPostBody = memberVarObjectMapper.writeValueAsBytes(updateCounterparty);
