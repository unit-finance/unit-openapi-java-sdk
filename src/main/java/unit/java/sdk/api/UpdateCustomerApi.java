...
import unit.java.sdk.model.UpdateCustomer;
...
public class UpdateCustomerApi {
  ...
  public UnitCustomerResponse execute(String customerId, UpdateCustomer updateCustomer) throws ApiException {
    ApiResponse<UnitCustomerResponse> localVarResponse = executeWithHttpInfo(customerId, updateCustomer);
  ...
  public ApiResponse<UnitCustomerResponse> executeWithHttpInfo(String customerId, UpdateCustomer updateCustomer) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = executeRequestBuilder(customerId, updateCustomer);
    try {
  ...
  private HttpRequest.Builder executeRequestBuilder(String customerId, UpdateCustomer updateCustomer) throws ApiException {
    ...
    if (updateCustomer == null) {
      throw new ApiException(400, "Missing the required parameter 'updateCustomer' when calling execute");
    }
    ...
    try {
      byte[] localVarPostBody = memberVarObjectMapper.writeValueAsBytes(updateCustomer);
