...
public class UpdateTransactionApi {
  ...
  private HttpRequest.Builder executeRequestBuilder(String accountId, String transactionId, UpdateTransaction updateTransaction) throws ApiException {
    ...
    if (transactionId == null) {
      throw new ApiException(400, "Missing the required parameter 'transactionId' when calling execute");
    }
    // verify the required parameter 'updateTransaction' is set
    if (updateTransaction == null) {
      throw new ApiException(400, "Missing the required parameter 'updateTransaction' when calling execute");
    }
    ...
    try {
      byte[] localVarPostBody = memberVarObjectMapper.writeValueAsBytes(updateTransaction);
