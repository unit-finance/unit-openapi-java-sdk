...
public class UploadAJpegDocumentForAnApplicationBackSideApi {
  ...
  public UploadAJpegDocumentForAnApplicationBackSideApi() {
    this(new ApiClient());
  }

  public UploadAJpegDocumentForAnApplicationBackSideApi(ApiClient apiClient) {
  ...
  private HttpRequest.Builder executeRequestBuilder(String applicationId, String documentId, Object body) throws ApiException {
    ...
    localVarRequestBuilder.header("Content-Type", "image/jpeg");
