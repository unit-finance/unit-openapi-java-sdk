...
public class VerifyADocumentForAnApplicationApi {
  ...
  public UnitDocumentResponse execute(String applicationId, String documentId, VerifyDocument verifyDocument) throws ApiException {
    ApiResponse<UnitDocumentResponse> localVarResponse = executeWithHttpInfo(applicationId, documentId, verifyDocument);
  ...
  public ApiResponse<UnitDocumentResponse> executeWithHttpInfo(String applicationId, String documentId, VerifyDocument verifyDocument) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = executeRequestBuilder(applicationId, documentId, verifyDocument);
    try {
  ...
  private HttpRequest.Builder executeRequestBuilder(String applicationId, String documentId, VerifyDocument verifyDocument) throws ApiException {
    ...
    if (verifyDocument == null) {
      throw new ApiException(400, "Missing the required parameter 'verifyDocument' when calling execute");
    }
