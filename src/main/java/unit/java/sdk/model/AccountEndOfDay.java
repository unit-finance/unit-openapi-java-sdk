 ...
 */
@JsonPropertyOrder({
  AccountEndOfDay.JSON_PROPERTY_TYPE,
  AccountEndOfDay.JSON_PROPERTY_ID,
...
public class AccountEndOfDay {
  ...
  public AccountEndOfDay relationships(AccountEndOfDayRelationships relationships) {
  ...
  @JsonProperty(JSON_PROPERTY_RELATIONSHIPS)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setRelationships(AccountEndOfDayRelationships relationships) {
    this.relationships = relationships;
  }


  /**
   * Return true if this AccountEndOfDay object is equal to o.
   */
  @Override
