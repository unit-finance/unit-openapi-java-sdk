...
public class ApplicationFormPrefill {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(applicationType, fullName, ssn, passport, nationality, dateOfBirth, email, name, stateOfIncorporation, entityType, contact, officer, beneficialOwners, website, phone, address, dba, ein, hashCodeNullable(jwtSubject), industry);
  }
