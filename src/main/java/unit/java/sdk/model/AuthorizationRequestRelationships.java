...
public class AuthorizationRequestRelationships {
  ...
  public AuthorizationRequestRelationships customer(CustomerRelationship customer) {
  ...
  public AuthorizationRequestRelationships account(AccountRelationship account) {
  ...
  public AuthorizationRequestRelationships fundingAccount(FundingAccountRelationship fundingAccount) {
  ...
  public AuthorizationRequestRelationships card(CardRelationship card) {
    this.card = card;
    return this;
  }
