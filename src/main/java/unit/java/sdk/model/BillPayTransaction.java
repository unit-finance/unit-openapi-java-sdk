 ...
 */
@JsonPropertyOrder({
  BillPayTransaction.JSON_PROPERTY_ATTRIBUTES,
  BillPayTransaction.JSON_PROPERTY_RELATIONSHIPS
})
...
public class BillPayTransaction extends Transaction {
  ...
  **/
  ...
  @Override
  public BillPayTransaction id(String id) {
    this.setId(id);
    return this;
  }

  @Override
  public BillPayTransaction type(String type) {
    this.setType(type);
    return this;
  }

  /**
   * Return true if this BillPayTransaction object is equal to o.
   */
  @Override
...
static {
  ...
  JSON.registerDiscriminator(BillPayTransaction.class, "type", mappings);
}
}
