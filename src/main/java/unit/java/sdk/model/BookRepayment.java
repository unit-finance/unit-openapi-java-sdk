 ...
 */
@JsonPropertyOrder({
  BookRepayment.JSON_PROPERTY_ATTRIBUTES,
  BookRepayment.JSON_PROPERTY_RELATIONSHIPS
})
...
public class BookRepayment extends Repayment {
  ...
  **/
  ...
  @Override
  public BookRepayment type(String type) {
    this.setType(type);
    return this;
  }

  /**
   * Return true if this BookRepayment object is equal to o.
   */
  @Override
