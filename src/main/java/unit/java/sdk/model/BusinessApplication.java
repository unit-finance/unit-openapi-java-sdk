 ...
 */
@JsonPropertyOrder({
  BusinessApplication.JSON_PROPERTY_ATTRIBUTES,
  BusinessApplication.JSON_PROPERTY_RELATIONSHIPS
})
...
public class BusinessApplication extends Application {
  ...
  @Override
  public BusinessApplication id(String id) {
    this.setId(id);
    return this;
  }

  @Override
  public BusinessApplication type(TypeEnum type) {
    this.setType(type);
    return this;
  }

  /**
   * Return true if this BusinessApplication object is equal to o.
   */
  @Override
...
static {
  ...
  JSON.registerDiscriminator(BusinessApplication.class, "type", mappings);
}
}
