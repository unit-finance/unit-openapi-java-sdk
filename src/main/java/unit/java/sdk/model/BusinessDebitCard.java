 ...
 */
@JsonPropertyOrder({
  BusinessDebitCard.JSON_PROPERTY_ATTRIBUTES,
  BusinessDebitCard.JSON_PROPERTY_RELATIONSHIPS
})
...
public class BusinessDebitCard extends Card {
  ...
  @Override
  public BusinessDebitCard type(TypeEnum type) {
    this.setType(type);
    return this;
  }
  ...
  /**
   * Return true if this BusinessDebitCard object is equal to o.
   */
  @Override
