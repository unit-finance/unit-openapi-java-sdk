...
public class CardTotals {
  ...
  public CardTotals withdrawals(Integer withdrawals) {
  ...
  public CardTotals deposits(Integer deposits) {
  ...
  public CardTotals purchases(Integer purchases) {
  ...
  public CardTotals cardTransactions(Integer cardTransactions) {
  ...
  @JsonProperty(JSON_PROPERTY_CARD_TRANSACTIONS)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setCardTransactions(Integer cardTransactions) {
    this.cardTransactions = cardTransactions;
  }
