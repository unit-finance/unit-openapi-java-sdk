...
/**
 * CardTransactionAuthorizationAllOfAttributes
 */
@JsonPropertyOrder({
  CardTransactionAuthorizationAllOfAttributes.JSON_PROPERTY_CREATED_AT,
  CardTransactionAuthorizationAllOfAttributes.JSON_PROPERTY_AMOUNT,
  CardTransactionAuthorizationAllOfAttributes.JSON_PROPERTY_STATUS,
  CardTransactionAuthorizationAllOfAttributes.JSON_PROPERTY_PARTIAL_APPROVAL_ALLOWED,
  CardTransactionAuthorizationAllOfAttributes.JSON_PROPERTY_APPROVED_AMOUNT,
  CardTransactionAuthorizationAllOfAttributes.JSON_PROPERTY_DECLINE_REASON,
  CardTransactionAuthorizationAllOfAttributes.JSON_PROPERTY_MERCHANT,
  CardTransactionAuthorizationAllOfAttributes.JSON_PROPERTY_RECURRING,
  CardTransactionAuthorizationAllOfAttributes.JSON_PROPERTY_TAGS,
  CardTransactionAuthorizationAllOfAttributes.JSON_PROPERTY_PAYMENT_METHOD,
  CardTransactionAuthorizationAllOfAttributes.JSON_PROPERTY_DIGITAL_WALLET,
  CardTransactionAuthorizationAllOfAttributes.JSON_PROPERTY_CARD_VERIFICATION_DATA,
  CardTransactionAuthorizationAllOfAttributes.JSON_PROPERTY_CARD_NETWORK
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.5.0")
public class CardTransactionAuthorizationAllOfAttributes {
  ...
  public CardTransactionAuthorizationAllOfAttributes() { 
  }

  public CardTransactionAuthorizationAllOfAttributes createdAt(OffsetDateTime createdAt) {
  ...
  **/
  ...
  public CardTransactionAuthorizationAllOfAttributes amount(Integer amount) {
    this.amount = amount;
    return this;
  }
  ...
  **/
  ...
  public CardTransactionAuthorizationAllOfAttributes status(String status) {
    this.status = status;
    return this;
  }
  ...
  **/
  ...
  public CardTransactionAuthorizationAllOfAttributes partialApprovalAllowed(Boolean partialApprovalAllowed) {
  ...
  **/
  ...
  public CardTransactionAuthorizationAllOfAttributes approvedAmount(Integer approvedAmount) {
  ...
  **/
  ...
  public CardTransactionAuthorizationAllOfAttributes declineReason(String declineReason) {
  ...
  **/
  ...
  public CardTransactionAuthorizationAllOfAttributes merchant(Merchant merchant) {
  ...
  **/
  ...
  public CardTransactionAuthorizationAllOfAttributes recurring(Boolean recurring) {
  ...
  **/
  ...
  public CardTransactionAuthorizationAllOfAttributes tags(Map<String, String> tags) {
    this.tags = tags;
    return this;
  }

  public CardTransactionAuthorizationAllOfAttributes putTagsItem(String key, String tagsItem) {
    if (this.tags == null) {
  ...
  **/
  ...
  public CardTransactionAuthorizationAllOfAttributes paymentMethod(String paymentMethod) {
  ...
  **/
  ...
  public CardTransactionAuthorizationAllOfAttributes digitalWallet(String digitalWallet) {
  ...
  **/
  ...
  public CardTransactionAuthorizationAllOfAttributes cardVerificationData(CardVerificationData cardVerificationData) {
  ...
  **/
  ...
  public CardTransactionAuthorizationAllOfAttributes cardNetwork(String cardNetwork) {
  ...
  **/
  ...
  /**
   * Return true if this CardTransactionAuthorization_allOf_attributes object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    CardTransactionAuthorizationAllOfAttributes cardTransactionAuthorizationAllOfAttributes = (CardTransactionAuthorizationAllOfAttributes) o;
    return Objects.equals(this.createdAt, cardTransactionAuthorizationAllOfAttributes.createdAt) &&
        Objects.equals(this.amount, cardTransactionAuthorizationAllOfAttributes.amount) &&
        Objects.equals(this.status, cardTransactionAuthorizationAllOfAttributes.status) &&
        Objects.equals(this.partialApprovalAllowed, cardTransactionAuthorizationAllOfAttributes.partialApprovalAllowed) &&
        Objects.equals(this.approvedAmount, cardTransactionAuthorizationAllOfAttributes.approvedAmount) &&
        Objects.equals(this.declineReason, cardTransactionAuthorizationAllOfAttributes.declineReason) &&
        Objects.equals(this.merchant, cardTransactionAuthorizationAllOfAttributes.merchant) &&
        Objects.equals(this.recurring, cardTransactionAuthorizationAllOfAttributes.recurring) &&
        Objects.equals(this.tags, cardTransactionAuthorizationAllOfAttributes.tags) &&
        Objects.equals(this.paymentMethod, cardTransactionAuthorizationAllOfAttributes.paymentMethod) &&
        Objects.equals(this.digitalWallet, cardTransactionAuthorizationAllOfAttributes.digitalWallet) &&
        Objects.equals(this.cardVerificationData, cardTransactionAuthorizationAllOfAttributes.cardVerificationData) &&
        Objects.equals(this.cardNetwork, cardTransactionAuthorizationAllOfAttributes.cardNetwork);
  }
  ...
  public String toString() {
    ...
    sb.append("class CardTransactionAuthorizationAllOfAttributes {\n");
