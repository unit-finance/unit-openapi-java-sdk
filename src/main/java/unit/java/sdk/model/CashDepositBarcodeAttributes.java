 ...
 */
@JsonPropertyOrder({
  CashDepositBarcodeAttributes.JSON_PROPERTY_BARCODE_NUMBER,
  CashDepositBarcodeAttributes.JSON_PROPERTY_EXPIRATION,
  CashDepositBarcodeAttributes.JSON_PROPERTY_TAGS
})
...
public class CashDepositBarcodeAttributes {
  ...
  public CashDepositBarcodeAttributes() { 
  }
  ...
  /**
   * Return true if this CashDepositBarcode_attributes object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.barcodeNumber, cashDepositBarcodeAttributes.barcodeNumber) &&
        Objects.equals(this.expiration, cashDepositBarcodeAttributes.expiration) &&
        Objects.equals(this.tags, cashDepositBarcodeAttributes.tags);
  }

  @Override
  public int hashCode() {
    return Objects.hash(barcodeNumber, expiration, tags);
  }
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `barcodeNumber` to the URL query string
    if (getBarcodeNumber() != null) {
      joiner.add(String.format("%sbarcodeNumber%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getBarcodeNumber()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
