...
public class ChargebackTransactionAllOfAttributes {
  ...
  public ChargebackTransactionAllOfAttributes counterparty(PaymentCounterparty counterparty) {
  ...
  public ChargebackTransactionAllOfAttributes amount(Long amount) {
    this.amount = amount;
    return this;
  }
  ...
  public ChargebackTransactionAllOfAttributes balance(Long balance) {
  ...
  public ChargebackTransactionAllOfAttributes tags(Map<String, String> tags) {
    this.tags = tags;
    return this;
  }

  public ChargebackTransactionAllOfAttributes putTagsItem(String key, String tagsItem) {
    if (this.tags == null) {
