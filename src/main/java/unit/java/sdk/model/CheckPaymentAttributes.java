...
import java.util.Map;
import unit.java.sdk.model.CheckPaymentCounterparty;
...
public class CheckPaymentAttributes {
  ...
  private CheckPaymentCounterparty counterparty;
  ...
  private List<PendingReviewReasonsEnum> pendingReviewReasons = new ArrayList<>();
  ...
  public CheckPaymentAttributes amount(Long amount) {
    this.amount = amount;
    return this;
  }
  ...
  public CheckPaymentAttributes counterparty(CheckPaymentCounterparty counterparty) {
  ...
  @JsonProperty(JSON_PROPERTY_COUNTERPARTY)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setCounterparty(CheckPaymentCounterparty counterparty) {
    this.counterparty = counterparty;
  }
  ...
  public CheckPaymentAttributes tags(Map<String, String> tags) {
    this.tags = tags;
    return this;
  }

  public CheckPaymentAttributes putTagsItem(String key, String tagsItem) {
    if (this.tags == null) {
