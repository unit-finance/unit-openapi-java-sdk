 ...
 */
@JsonPropertyOrder({
  CheckPaymentRelationships.JSON_PROPERTY_ACCOUNT,
  CheckPaymentRelationships.JSON_PROPERTY_CUSTOMER,
  CheckPaymentRelationships.JSON_PROPERTY_CUSTOMERS,
  CheckPaymentRelationships.JSON_PROPERTY_TRANSACTION
})
...
public class CheckPaymentRelationships {
  ...
  public CheckPaymentRelationships account(AccountRelationship account) {
  ...
  public CheckPaymentRelationships customer(CustomerRelationship customer) {
  ...
  public CheckPaymentRelationships transaction(TransactionRelationship transaction) {
  ...
  /**
   * Return true if this CheckPaymentRelationships object is equal to o.
   */
  @Override
