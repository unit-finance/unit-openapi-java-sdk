 ...
 */
@JsonPropertyOrder({
  CreateBookPayment.JSON_PROPERTY_TYPE,
  CreateBookPayment.JSON_PROPERTY_ATTRIBUTES,
  CreateBookPayment.JSON_PROPERTY_RELATIONSHIPS
})
...
public class CreateBookPayment {
  ...
  public CreateBookPayment type(TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  /**
   * Return true if this CreateBookPayment object is equal to o.
   */
  @Override
