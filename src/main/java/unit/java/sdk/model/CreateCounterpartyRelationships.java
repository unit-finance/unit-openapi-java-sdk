 ...
 */
@JsonPropertyOrder({
  CreateCounterpartyRelationships.JSON_PROPERTY_CUSTOMER
})
...
public class CreateCounterpartyRelationships {
  ...
  public CreateCounterpartyRelationships customer(CustomerRelationship customer) {
  ...
  /**
   * Return true if this CreateCounterpartyRelationships object is equal to o.
   */
  @Override
