 ...
 */
@JsonPropertyOrder({
  CreateDepositAccountRelationships.JSON_PROPERTY_CUSTOMER,
  CreateDepositAccountRelationships.JSON_PROPERTY_CUSTOMERS
})
...
public class CreateDepositAccountRelationships {
  ...
  public CreateDepositAccountRelationships customer(CustomerRelationship customer) {
  ...
  /**
   * Return true if this CreateDepositAccount_relationships object is equal to o.
   */
  @Override
