...
@JsonPropertyOrder({
  ...
  CreateIndividualApplicationAttributes.JSON_PROPERTY_OPERATING_ADDRESS
})
...
public class CreateIndividualApplicationAttributes {
  ...
  public CreateIndividualApplicationAttributes tags(Map<String, String> tags) {
    this.tags = tags;
    return this;
  }

  public CreateIndividualApplicationAttributes putTagsItem(String key, String tagsItem) {
    if (this.tags == null) {
  ...
  public CreateIndividualApplicationAttributes operatingAddress(Address operatingAddress) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.fullName, createIndividualApplicationAttributes.fullName) &&
        ...
        Objects.equals(this.operatingAddress, createIndividualApplicationAttributes.operatingAddress);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(fullName, email, phone, hashCodeNullable(ssn), hashCodeNullable(passport), nationality, address, dateOfBirth, ip, tags, idempotencyKey, deviceFingerprints, hashCodeNullable(jwtSubject), powerOfAttorneyAgent, industry, evaluationParams, occupation, annualIncome, sourceOfIncome, operatingAddress);
  }
