 ...
 */
@JsonPropertyOrder({
  CreatePaymentRequest.JSON_PROPERTY_DATA
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.9.0")
public class CreatePaymentRequest {
  public static final String JSON_PROPERTY_DATA = "data";
  private CreatePaymentRequestData data;

  public CreatePaymentRequest() { 
  }

  public CreatePaymentRequest data(CreatePaymentRequestData data) {
    this.data = data;
    return this;
  }
  ...
  public CreatePaymentRequestData getData() {
    return data;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(CreatePaymentRequestData data) {
    this.data = data;
  }
