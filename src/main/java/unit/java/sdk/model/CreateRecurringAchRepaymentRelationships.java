 ...
 */
@JsonPropertyOrder({
  CreateRecurringAchRepaymentRelationships.JSON_PROPERTY_ACCOUNT,
  CreateRecurringAchRepaymentRelationships.JSON_PROPERTY_CREDIT_ACCOUNT,
  CreateRecurringAchRepaymentRelationships.JSON_PROPERTY_COUNTERPARTY
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.9.0")
public class CreateRecurringAchRepaymentRelationships {
  ...
  public CreateRecurringAchRepaymentRelationships() { 
  }

  public CreateRecurringAchRepaymentRelationships account(AccountRelationship account) {
  ...
  public CreateRecurringAchRepaymentRelationships creditAccount(CreditAccountRelationship creditAccount) {
  ...
  public CreateRecurringAchRepaymentRelationships counterparty(CounterpartyRelationship counterparty) {
  ...
  /**
   * Return true if this CreateRecurringAchRepaymentRelationships object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    CreateRecurringAchRepaymentRelationships createRecurringAchRepaymentRelationships = (CreateRecurringAchRepaymentRelationships) o;
    return Objects.equals(this.account, createRecurringAchRepaymentRelationships.account) &&
        Objects.equals(this.creditAccount, createRecurringAchRepaymentRelationships.creditAccount) &&
        Objects.equals(this.counterparty, createRecurringAchRepaymentRelationships.counterparty);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateRecurringAchRepaymentRelationships {\n");
