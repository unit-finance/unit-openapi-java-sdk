...
public class CreateRecurringDebitAchPaymentAttributes {
  ...
  public CreateRecurringDebitAchPaymentAttributes amount(Long amount) {
    this.amount = amount;
    return this;
  }
  ...
  public CreateRecurringDebitAchPaymentAttributes tags(Map<String, String> tags) {
    this.tags = tags;
    return this;
  }

  public CreateRecurringDebitAchPaymentAttributes putTagsItem(String key, String tagsItem) {
    if (this.tags == null) {
  ...
  public CreateRecurringDebitAchPaymentAttributes schedule(Schedule schedule) {
