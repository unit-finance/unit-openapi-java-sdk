...
@JsonDeserialize(using = CreateRecurringPaymentData.CreateRecurringPaymentDataDeserializer.class)
@JsonSerialize(using = CreateRecurringPaymentData.CreateRecurringPaymentDataSerializer.class)
public class CreateRecurringPaymentData extends AbstractOpenApiSchema {
    ...
    public static class CreateRecurringPaymentDataSerializer extends StdSerializer<CreateRecurringPaymentData> {
        public CreateRecurringPaymentDataSerializer(Class<CreateRecurringPaymentData> t) {
            super(t);
        }
        ...
        @Override
        public void serialize(CreateRecurringPaymentData value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
    ...
    public static class CreateRecurringPaymentDataDeserializer extends StdDeserializer<CreateRecurringPaymentData> {
        ...
        public CreateRecurringPaymentDataDeserializer(Class<?> vc) {
            super(vc);
        }

        @Override
        public CreateRecurringPaymentData deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            throw new IOException(String.format("Failed deserialization for CreateRecurringPaymentData: %d classes match result, expected 1", match));
        }
         ...
         */
        @Override
        public CreateRecurringPaymentData getNullValue(DeserializationContext ctxt) throws JsonMappingException {
            throw new JsonMappingException(ctxt.getParser(), "CreateRecurringPaymentData cannot be null");
        }
    }
