 ...
 */
@JsonPropertyOrder({
  CustomerRepaymentReturnedTransactionRelationships.JSON_PROPERTY_ACCOUNT,
  CustomerRepaymentReturnedTransactionRelationships.JSON_PROPERTY_CUSTOMER,
  CustomerRepaymentReturnedTransactionRelationships.JSON_PROPERTY_CUSTOMERS,
  CustomerRepaymentReturnedTransactionRelationships.JSON_PROPERTY_ORG,
  CustomerRepaymentReturnedTransactionRelationships.JSON_PROPERTY_REPAYMENT
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.9.0")
public class CustomerRepaymentReturnedTransactionRelationships {
  ...
  public CustomerRepaymentReturnedTransactionRelationships() { 
  }

  public CustomerRepaymentReturnedTransactionRelationships account(AccountRelationship account) {
  ...
  public CustomerRepaymentReturnedTransactionRelationships customer(CustomerRelationship customer) {
  ...
  public CustomerRepaymentReturnedTransactionRelationships customers(CustomersRelationship customers) {
  ...
  public CustomerRepaymentReturnedTransactionRelationships org(OrgRelationship org) {
    this.org = org;
    return this;
  }
  ...
  public CustomerRepaymentReturnedTransactionRelationships repayment(RepaymentRelationship repayment) {
  ...
  /**
   * Return true if this CustomerRepaymentReturnedTransactionRelationships object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    CustomerRepaymentReturnedTransactionRelationships customerRepaymentReturnedTransactionRelationships = (CustomerRepaymentReturnedTransactionRelationships) o;
    return Objects.equals(this.account, customerRepaymentReturnedTransactionRelationships.account) &&
        Objects.equals(this.customer, customerRepaymentReturnedTransactionRelationships.customer) &&
        Objects.equals(this.customers, customerRepaymentReturnedTransactionRelationships.customers) &&
        Objects.equals(this.org, customerRepaymentReturnedTransactionRelationships.org) &&
        Objects.equals(this.repayment, customerRepaymentReturnedTransactionRelationships.repayment);
  }
  ...
  public String toString() {
    ...
    sb.append("class CustomerRepaymentReturnedTransactionRelationships {\n");
