...
import unit.java.sdk.model.DepositAccountAllOfAttributes;
import unit.java.sdk.model.DepositAccountAllOfRelationships;
 ...
 */
@JsonPropertyOrder({
  DepositAccount.JSON_PROPERTY_ATTRIBUTES,
  DepositAccount.JSON_PROPERTY_RELATIONSHIPS
})
...
public class DepositAccount extends Account {
  ...
  private DepositAccountAllOfRelationships relationships;
  ...
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public DepositAccountAllOfRelationships getRelationships() {
    return relationships;
  }
  ...
  @Override
  public DepositAccount type(TypeEnum type) {
    this.setType(type);
    return this;
  }
...
static {
  ...
  JSON.registerDiscriminator(DepositAccount.class, "type", mappings);
}
}
