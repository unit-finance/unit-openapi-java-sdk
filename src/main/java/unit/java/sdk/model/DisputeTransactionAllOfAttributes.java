...
public class DisputeTransactionAllOfAttributes {
  ...
  public DisputeTransactionAllOfAttributes amount(Long amount) {
    this.amount = amount;
    return this;
  }
  ...
  public DisputeTransactionAllOfAttributes balance(Long balance) {
  ...
  public DisputeTransactionAllOfAttributes tags(Map<String, String> tags) {
    this.tags = tags;
    return this;
  }

  public DisputeTransactionAllOfAttributes putTagsItem(String key, String tagsItem) {
    if (this.tags == null) {
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getDisputeId() != null) {
      joiner.add(String.format("%sdisputeId%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getDisputeId()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
