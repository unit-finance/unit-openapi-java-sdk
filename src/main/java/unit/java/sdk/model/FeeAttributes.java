 ...
 */
@JsonPropertyOrder({
  FeeAttributes.JSON_PROPERTY_AMOUNT,
  FeeAttributes.JSON_PROPERTY_DESCRIPTION,
  FeeAttributes.JSON_PROPERTY_TAGS
})
...
public class FeeAttributes {
  ...
  public FeeAttributes amount(Long amount) {
    this.amount = amount;
    return this;
  }
  ...
  public FeeAttributes tags(Map<String, String> tags) {
    this.tags = tags;
    return this;
  }

  public FeeAttributes putTagsItem(String key, String tagsItem) {
    if (this.tags == null) {
  ...
  /**
   * Return true if this Fee_attributes object is equal to o.
   */
  @Override
