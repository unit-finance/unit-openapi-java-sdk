 ...
 */
@JsonPropertyOrder({
  GetListRewardsFilterParameter.JSON_PROPERTY_TRANSACTION_ID,
  GetListRewardsFilterParameter.JSON_PROPERTY_REWARDED_TRANSACTION_ID,
  GetListRewardsFilterParameter.JSON_PROPERTY_RECEIVING_ACCOUNT_ID,
  GetListRewardsFilterParameter.JSON_PROPERTY_CUSTOMER_ID,
  GetListRewardsFilterParameter.JSON_PROPERTY_CARD_ID,
  GetListRewardsFilterParameter.JSON_PROPERTY_SINCE,
  GetListRewardsFilterParameter.JSON_PROPERTY_UNTIL,
  GetListRewardsFilterParameter.JSON_PROPERTY_STATUS,
  GetListRewardsFilterParameter.JSON_PROPERTY_TAGS
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.5.0")
public class GetListRewardsFilterParameter {
  ...
  public GetListRewardsFilterParameter() { 
  }

  public GetListRewardsFilterParameter transactionId(String transactionId) {
  ...
  **/
  ...
  public GetListRewardsFilterParameter rewardedTransactionId(String rewardedTransactionId) {
  ...
  **/
  ...
  public GetListRewardsFilterParameter receivingAccountId(String receivingAccountId) {
  ...
  **/
  ...
  public GetListRewardsFilterParameter customerId(String customerId) {
  ...
  **/
  ...
  public GetListRewardsFilterParameter cardId(String cardId) {
    this.cardId = cardId;
    return this;
  }
  ...
  **/
  ...
  public GetListRewardsFilterParameter since(String since) {
    this.since = since;
    return this;
  }
  ...
  **/
  ...
  public GetListRewardsFilterParameter until(String until) {
    this.until = until;
    return this;
  }
  ...
  **/
  ...
  public GetListRewardsFilterParameter status(String status) {
    this.status = status;
    return this;
  }
  ...
  **/
  ...
  public GetListRewardsFilterParameter tags(Map<String, String> tags) {
    this.tags = tags;
    return this;
  }

  public GetListRewardsFilterParameter putTagsItem(String key, String tagsItem) {
    if (this.tags == null) {
  ...
  **/
  ...
  /**
   * Return true if this getListRewards_filter_parameter object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    GetListRewardsFilterParameter getListRewardsFilterParameter = (GetListRewardsFilterParameter) o;
    return Objects.equals(this.transactionId, getListRewardsFilterParameter.transactionId) &&
        Objects.equals(this.rewardedTransactionId, getListRewardsFilterParameter.rewardedTransactionId) &&
        Objects.equals(this.receivingAccountId, getListRewardsFilterParameter.receivingAccountId) &&
        Objects.equals(this.customerId, getListRewardsFilterParameter.customerId) &&
        Objects.equals(this.cardId, getListRewardsFilterParameter.cardId) &&
        Objects.equals(this.since, getListRewardsFilterParameter.since) &&
        Objects.equals(this.until, getListRewardsFilterParameter.until) &&
        Objects.equals(this.status, getListRewardsFilterParameter.status) &&
        Objects.equals(this.tags, getListRewardsFilterParameter.tags);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetListRewardsFilterParameter {\n");
