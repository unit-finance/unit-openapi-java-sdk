 ...
 */
@JsonPropertyOrder({
  IncludedResourceInner.JSON_PROPERTY_ID,
  IncludedResourceInner.JSON_PROPERTY_TYPE,
  IncludedResourceInner.JSON_PROPERTY_ATTRIBUTES,
  IncludedResourceInner.JSON_PROPERTY_RELATIONSHIPS
})
...
public class IncludedResourceInner {
  ...
  /**
   * Return true if this IncludedResource_inner object is equal to o.
   */
  @Override
