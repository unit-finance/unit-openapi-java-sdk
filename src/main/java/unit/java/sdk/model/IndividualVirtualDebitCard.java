...
import unit.java.sdk.model.IndividualVirtualDebitCardAllOfAttributes;
 ...
 */
@JsonPropertyOrder({
  IndividualVirtualDebitCard.JSON_PROPERTY_ATTRIBUTES,
  IndividualVirtualDebitCard.JSON_PROPERTY_RELATIONSHIPS
})
...
public class IndividualVirtualDebitCard extends Card {
  ...
  @Override
  public IndividualVirtualDebitCard type(TypeEnum type) {
    this.setType(type);
    return this;
  }

  @Override
  public IndividualVirtualDebitCard id(String id) {
    this.setId(id);
    return this;
  }

  /**
   * Return true if this IndividualVirtualDebitCard object is equal to o.
   */
  @Override
...
static {
  ...
  JSON.registerDiscriminator(IndividualVirtualDebitCard.class, "type", mappings);
}
}
