...
public class Officer {
  ...
  private BigDecimal idTheftScore;
  ...
  public Officer idTheftScore(BigDecimal idTheftScore) {
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public BigDecimal getIdTheftScore() {
    return idTheftScore;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ID_THEFT_SCORE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setIdTheftScore(BigDecimal idTheftScore) {
    this.idTheftScore = idTheftScore;
  }
