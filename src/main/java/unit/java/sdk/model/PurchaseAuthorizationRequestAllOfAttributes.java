 ...
 */
@JsonPropertyOrder({
  PurchaseAuthorizationRequestAllOfAttributes.JSON_PROPERTY_CREATED_AT,
  PurchaseAuthorizationRequestAllOfAttributes.JSON_PROPERTY_AMOUNT,
  PurchaseAuthorizationRequestAllOfAttributes.JSON_PROPERTY_STATUS,
  PurchaseAuthorizationRequestAllOfAttributes.JSON_PROPERTY_PARTIAL_APPROVAL_ALLOWED,
  PurchaseAuthorizationRequestAllOfAttributes.JSON_PROPERTY_APPROVED_AMOUNT,
  PurchaseAuthorizationRequestAllOfAttributes.JSON_PROPERTY_DECLINE_REASON,
  PurchaseAuthorizationRequestAllOfAttributes.JSON_PROPERTY_MERCHANT,
  PurchaseAuthorizationRequestAllOfAttributes.JSON_PROPERTY_RECURRING,
  PurchaseAuthorizationRequestAllOfAttributes.JSON_PROPERTY_TAGS,
  PurchaseAuthorizationRequestAllOfAttributes.JSON_PROPERTY_HEALTHCARE_AMOUNTS,
  PurchaseAuthorizationRequestAllOfAttributes.JSON_PROPERTY_PAYMENT_METHOD,
  PurchaseAuthorizationRequestAllOfAttributes.JSON_PROPERTY_DIGITAL_WALLET,
  PurchaseAuthorizationRequestAllOfAttributes.JSON_PROPERTY_CARD_VERIFICATION_DATA,
  PurchaseAuthorizationRequestAllOfAttributes.JSON_PROPERTY_ECOMMERCE,
  PurchaseAuthorizationRequestAllOfAttributes.JSON_PROPERTY_CARD_PRESENT,
  PurchaseAuthorizationRequestAllOfAttributes.JSON_PROPERTY_CARD_NETWORK,
  PurchaseAuthorizationRequestAllOfAttributes.JSON_PROPERTY_CASH_WITHDRAWAL_AMOUNT
})
...
public class PurchaseAuthorizationRequestAllOfAttributes {
  ...
  **/
  ...
  /**
   * Return true if this PurchaseAuthorizationRequest_allOf_attributes object is equal to o.
   */
  @Override
