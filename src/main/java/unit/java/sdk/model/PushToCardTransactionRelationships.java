 ...
 */
@JsonPropertyOrder({
  PushToCardTransactionRelationships.JSON_PROPERTY_ACCOUNT,
  PushToCardTransactionRelationships.JSON_PROPERTY_CUSTOMER,
  PushToCardTransactionRelationships.JSON_PROPERTY_CUSTOMERS,
  PushToCardTransactionRelationships.JSON_PROPERTY_PAYMENT,
  PushToCardTransactionRelationships.JSON_PROPERTY_ORG
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.9.0")
public class PushToCardTransactionRelationships {
  ...
  public PushToCardTransactionRelationships() { 
  }

  public PushToCardTransactionRelationships account(AccountRelationship account) {
  ...
  public PushToCardTransactionRelationships customer(CustomerRelationship customer) {
  ...
  public PushToCardTransactionRelationships customers(CustomersRelationship customers) {
  ...
  public PushToCardTransactionRelationships payment(PaymentRelationship payment) {
  ...
  public PushToCardTransactionRelationships org(OrgRelationship org) {
    this.org = org;
    return this;
  }
  ...
  /**
   * Return true if this PushToCardTransactionRelationships object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PushToCardTransactionRelationships pushToCardTransactionRelationships = (PushToCardTransactionRelationships) o;
    return Objects.equals(this.account, pushToCardTransactionRelationships.account) &&
        Objects.equals(this.customer, pushToCardTransactionRelationships.customer) &&
        Objects.equals(this.customers, pushToCardTransactionRelationships.customers) &&
        Objects.equals(this.payment, pushToCardTransactionRelationships.payment) &&
        Objects.equals(this.org, pushToCardTransactionRelationships.org);
  }

  @Override
  public int hashCode() {
    return Objects.hash(account, customer, customers, payment, org);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PushToCardTransactionRelationships {\n");
