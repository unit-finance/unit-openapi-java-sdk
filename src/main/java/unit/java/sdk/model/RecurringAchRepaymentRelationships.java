 ...
 */
@JsonPropertyOrder({
  RecurringAchRepaymentRelationships.JSON_PROPERTY_CREDIT_ACCOUNT,
  RecurringAchRepaymentRelationships.JSON_PROPERTY_COUNTERPARTY,
  RecurringAchRepaymentRelationships.JSON_PROPERTY_CUSTOMER,
  RecurringAchRepaymentRelationships.JSON_PROPERTY_ORG,
  RecurringAchRepaymentRelationships.JSON_PROPERTY_ACCOUNT
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.9.0")
public class RecurringAchRepaymentRelationships {
  ...
  public RecurringAchRepaymentRelationships() { 
  }

  public RecurringAchRepaymentRelationships creditAccount(RecurringRepaymentRelationshipsBaseCreditAccount creditAccount) {
  ...
  public RecurringAchRepaymentRelationships counterparty(RecurringRepaymentRelationshipsBaseCounterparty counterparty) {
  ...
  public RecurringAchRepaymentRelationships customer(RecurringRepaymentRelationshipsBaseCustomer customer) {
  ...
  public RecurringAchRepaymentRelationships org(RecurringRepaymentRelationshipsBaseOrg org) {
    this.org = org;
    return this;
  }
  ...
  public RecurringAchRepaymentRelationships account(RecurringAchRepaymentRelationshipsAllOfAccount account) {
  ...
  /**
   * Return true if this RecurringAchRepaymentRelationships object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    RecurringAchRepaymentRelationships recurringAchRepaymentRelationships = (RecurringAchRepaymentRelationships) o;
    return Objects.equals(this.creditAccount, recurringAchRepaymentRelationships.creditAccount) &&
        Objects.equals(this.counterparty, recurringAchRepaymentRelationships.counterparty) &&
        Objects.equals(this.customer, recurringAchRepaymentRelationships.customer) &&
        Objects.equals(this.org, recurringAchRepaymentRelationships.org) &&
        Objects.equals(this.account, recurringAchRepaymentRelationships.account);
  }
  ...
  public String toString() {
    ...
    sb.append("class RecurringAchRepaymentRelationships {\n");
