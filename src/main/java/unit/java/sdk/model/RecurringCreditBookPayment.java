...
import unit.java.sdk.model.RecurringBookPaymentRelationships;
import unit.java.sdk.model.RecurringCreditBookPaymentAllOfAttributes;
 ...
 */
@JsonPropertyOrder({
  RecurringCreditBookPayment.JSON_PROPERTY_ATTRIBUTES,
  RecurringCreditBookPayment.JSON_PROPERTY_RELATIONSHIPS
})
...
public class RecurringCreditBookPayment extends RecurringPayment {
  ...
  @Override
  public RecurringCreditBookPayment type(TypeEnum type) {
    this.setType(type);
    return this;
  }

  @Override
  public RecurringCreditBookPayment id(String id) {
    this.setId(id);
    return this;
  }

  /**
   * Return true if this RecurringCreditBookPayment object is equal to o.
   */
  @Override
...
static {
  ...
  JSON.registerDiscriminator(RecurringCreditBookPayment.class, "type", mappings);
}
}
