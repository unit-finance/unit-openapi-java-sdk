...
public class RecurringCreditBookPaymentAllOfAttributes {
  ...
  public RecurringCreditBookPaymentAllOfAttributes amount(Long amount) {
    this.amount = amount;
    return this;
  }
  ...
  public RecurringCreditBookPaymentAllOfAttributes schedule(ResponseSchedule schedule) {
  ...
  public RecurringCreditBookPaymentAllOfAttributes tags(Map<String, String> tags) {
    this.tags = tags;
    return this;
  }

  public RecurringCreditBookPaymentAllOfAttributes putTagsItem(String key, String tagsItem) {
    if (this.tags == null) {
