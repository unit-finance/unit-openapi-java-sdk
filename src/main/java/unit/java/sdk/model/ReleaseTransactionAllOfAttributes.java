...
public class ReleaseTransactionAllOfAttributes {
  ...
  public ReleaseTransactionAllOfAttributes amount(Long amount) {
    this.amount = amount;
    return this;
  }
  ...
  public ReleaseTransactionAllOfAttributes balance(Long balance) {
  ...
  public ReleaseTransactionAllOfAttributes counterparty(PaymentCounterparty counterparty) {
  ...
  public ReleaseTransactionAllOfAttributes tags(Map<String, String> tags) {
    this.tags = tags;
    return this;
  }

  public ReleaseTransactionAllOfAttributes putTagsItem(String key, String tagsItem) {
    if (this.tags == null) {
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getSenderName() != null) {
      joiner.add(String.format("%ssenderName%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getSenderName()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
