...
import unit.java.sdk.model.RewardAttributes;
import unit.java.sdk.model.RewardRelationships;
 ...
 */
@JsonPropertyOrder({
  Reward.JSON_PROPERTY_TYPE,
  Reward.JSON_PROPERTY_ID,
  Reward.JSON_PROPERTY_ATTRIBUTES,
  Reward.JSON_PROPERTY_RELATIONSHIPS
})
...
public class Reward {
  ...
  public Reward relationships(RewardRelationships relationships) {
  ...
  @JsonProperty(JSON_PROPERTY_RELATIONSHIPS)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setRelationships(RewardRelationships relationships) {
    this.relationships = relationships;
  }
