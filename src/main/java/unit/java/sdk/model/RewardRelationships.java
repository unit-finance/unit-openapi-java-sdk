...
public class RewardRelationships {
  ...
  public RewardRelationships receivingAccount(ReceivingAccountRelationship receivingAccount) {
  ...
  public RewardRelationships fundingAccount(FundingAccountRelationship fundingAccount) {
  ...
  public RewardRelationships customer(CustomerRelationship customer) {
  ...
  public RewardRelationships rewardedTransaction(RewardedTransactionRelationship rewardedTransaction) {
