 ...
 */
@JsonPropertyOrder({
  RewardTransactionRelationships.JSON_PROPERTY_ACCOUNT,
  RewardTransactionRelationships.JSON_PROPERTY_CUSTOMER,
  RewardTransactionRelationships.JSON_PROPERTY_CUSTOMERS,
  RewardTransactionRelationships.JSON_PROPERTY_REWARD,
  RewardTransactionRelationships.JSON_PROPERTY_RECEIVER_ACCOUNT
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.9.0")
public class RewardTransactionRelationships {
  ...
  public RewardTransactionRelationships() { 
  }

  public RewardTransactionRelationships account(AccountRelationship account) {
  ...
  public RewardTransactionRelationships customer(CustomerRelationship customer) {
  ...
  public RewardTransactionRelationships customers(CustomersRelationship customers) {
  ...
  public RewardTransactionRelationships reward(RewardRelationship reward) {
    this.reward = reward;
    return this;
  }
  ...
  public RewardTransactionRelationships receiverAccount(ReceiverAccountRelationship receiverAccount) {
  ...
  /**
   * Return true if this RewardTransactionRelationships object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    RewardTransactionRelationships rewardTransactionRelationships = (RewardTransactionRelationships) o;
    return Objects.equals(this.account, rewardTransactionRelationships.account) &&
        Objects.equals(this.customer, rewardTransactionRelationships.customer) &&
        Objects.equals(this.customers, rewardTransactionRelationships.customers) &&
        Objects.equals(this.reward, rewardTransactionRelationships.reward) &&
        Objects.equals(this.receiverAccount, rewardTransactionRelationships.receiverAccount);
  }

  @Override
  public int hashCode() {
    return Objects.hash(account, customer, customers, reward, receiverAccount);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class RewardTransactionRelationships {\n");
