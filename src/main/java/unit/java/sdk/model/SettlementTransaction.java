 ...
 */
@JsonPropertyOrder({
  SettlementTransaction.JSON_PROPERTY_ATTRIBUTES,
  SettlementTransaction.JSON_PROPERTY_RELATIONSHIPS
})
...
public class SettlementTransaction extends Transaction {
  ...
  **/
  ...
  @Override
  public SettlementTransaction id(String id) {
    this.setId(id);
    return this;
  }

  @Override
  public SettlementTransaction type(String type) {
    this.setType(type);
    return this;
  }

  /**
   * Return true if this SettlementTransaction object is equal to o.
   */
  @Override
...
static {
  ...
  JSON.registerDiscriminator(SettlementTransaction.class, "type", mappings);
}
}
