 ...
 */
@JsonPropertyOrder({
  SponsoredInterestTransaction.JSON_PROPERTY_ATTRIBUTES,
  SponsoredInterestTransaction.JSON_PROPERTY_RELATIONSHIPS
})
...
public class SponsoredInterestTransaction extends Transaction {
  ...
  private SponsoredInterestTransaction relationships;
  ...
  public SponsoredInterestTransaction relationships(SponsoredInterestTransaction relationships) {
  ...
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public SponsoredInterestTransaction getRelationships() {
    return relationships;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RELATIONSHIPS)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setRelationships(SponsoredInterestTransaction relationships) {
    this.relationships = relationships;
  }


  @Override
  public SponsoredInterestTransaction id(String id) {
    this.setId(id);
    return this;
  }

  @Override
  public SponsoredInterestTransaction type(TypeEnum type) {
    this.setType(type);
    return this;
  }

  /**
   * Return true if this SponsoredInterestTransaction object is equal to o.
   */
  @Override
...
static {
  ...
  JSON.registerDiscriminator(SponsoredInterestTransaction.class, "type", mappings);
}
}
