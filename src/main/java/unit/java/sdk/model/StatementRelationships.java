 ...
 */
@JsonPropertyOrder({
  StatementRelationships.JSON_PROPERTY_ACCOUNT,
  StatementRelationships.JSON_PROPERTY_CUSTOMER,
  StatementRelationships.JSON_PROPERTY_CUSTOMERS
})
...
public class StatementRelationships {
  ...
  public StatementRelationships account(AccountRelationship account) {
  ...
  public StatementRelationships customer(CustomerRelationship customer) {
  ...
  /**
   * Return true if this StatementRelationships object is equal to o.
   */
  @Override
