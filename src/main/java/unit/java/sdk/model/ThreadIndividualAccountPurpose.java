...
/**
 * Gets or Sets ThreadIndividualAccountPurpose
 */
public enum ThreadIndividualAccountPurpose {
  ...
  DOMESTIC_P2_P_AND_BILL_PAY("DomesticP2PAndBillPay"),
  ...
  ThreadIndividualAccountPurpose(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static ThreadIndividualAccountPurpose fromValue(String value) {
    for (ThreadIndividualAccountPurpose b : ThreadIndividualAccountPurpose.values()) {
