 ...
 */
@JsonPropertyOrder({
  UnitCreateApplicationResponse.JSON_PROPERTY_DATA,
  UnitCreateApplicationResponse.JSON_PROPERTY_INCLUDED
})
...
public class UnitCreateApplicationResponse {
  ...
  public UnitCreateApplicationResponse included(List<ApplicationDocument> included) {
    this.included = included;
    return this;
  }

  public UnitCreateApplicationResponse addIncludedItem(ApplicationDocument includedItem) {
  ...
  /**
   * Return true if this Unit_Create_Application_Response object is equal to o.
   */
  @Override
