 ...
 */
@JsonPropertyOrder({
  UpdateBusinessDebitCardAttributes.JSON_PROPERTY_SHIPPING_ADDRESS,
  UpdateBusinessDebitCardAttributes.JSON_PROPERTY_ADDRESS,
  UpdateBusinessDebitCardAttributes.JSON_PROPERTY_PHONE,
  UpdateBusinessDebitCardAttributes.JSON_PROPERTY_EMAIL,
  UpdateBusinessDebitCardAttributes.JSON_PROPERTY_DESIGN,
  UpdateBusinessDebitCardAttributes.JSON_PROPERTY_TAGS,
...
public class UpdateBusinessDebitCardAttributes {
  ...
  public UpdateBusinessDebitCardAttributes() { 
  }

  public UpdateBusinessDebitCardAttributes shippingAddress(Address shippingAddress) {
  ...
  public UpdateBusinessDebitCardAttributes address(Address address) {
  ...
  public UpdateBusinessDebitCardAttributes phone(Phone phone) {
    this.phone = phone;
    return this;
  }
  ...
  public UpdateBusinessDebitCardAttributes email(String email) {
    this.email = email;
    return this;
  }
  ...
  public UpdateBusinessDebitCardAttributes design(String design) {
    this.design = design;
    return this;
  }
  ...
  public UpdateBusinessDebitCardAttributes tags(Map<String, String> tags) {
    this.tags = tags;
    return this;
  }

  public UpdateBusinessDebitCardAttributes putTagsItem(String key, String tagsItem) {
    if (this.tags == null) {
  ...
  public UpdateBusinessDebitCardAttributes limits(CardLevelLimits limits) {
    this.limits = limits;
    return this;
  }
  ...
  public UpdateBusinessDebitCardAttributes defaultFundingAccountId(String defaultFundingAccountId) {
  ...
  /**
   * Return true if this UpdateBusinessDebitCard_attributes object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    UpdateBusinessDebitCardAttributes updateBusinessDebitCardAttributes = (UpdateBusinessDebitCardAttributes) o;
    return Objects.equals(this.shippingAddress, updateBusinessDebitCardAttributes.shippingAddress) &&
        Objects.equals(this.address, updateBusinessDebitCardAttributes.address) &&
        Objects.equals(this.phone, updateBusinessDebitCardAttributes.phone) &&
        Objects.equals(this.email, updateBusinessDebitCardAttributes.email) &&
        Objects.equals(this.design, updateBusinessDebitCardAttributes.design) &&
        Objects.equals(this.tags, updateBusinessDebitCardAttributes.tags) &&
        Objects.equals(this.limits, updateBusinessDebitCardAttributes.limits) &&
        Objects.equals(this.defaultFundingAccountId, updateBusinessDebitCardAttributes.defaultFundingAccountId);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateBusinessDebitCardAttributes {\n");
