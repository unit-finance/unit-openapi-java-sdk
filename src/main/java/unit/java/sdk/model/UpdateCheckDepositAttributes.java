...
public class UpdateCheckDepositAttributes {
  ...
  public UpdateCheckDepositAttributes tags(Map<String, String> tags) {
    this.tags = tags;
    return this;
  }

  public UpdateCheckDepositAttributes putTagsItem(String key, String tagsItem) {
    if (this.tags == null) {
  ...
  /**
   * Return true if this UpdateCheckDeposit_attributes object is equal to o.
   */
  @Override
