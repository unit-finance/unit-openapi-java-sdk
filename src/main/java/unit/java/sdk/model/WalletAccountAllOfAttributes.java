...
public class WalletAccountAllOfAttributes {
  ...
  public WalletAccountAllOfAttributes balance(Integer balance) {
  ...
  public WalletAccountAllOfAttributes hold(Integer hold) {
    this.hold = hold;
    return this;
  }
  ...
  public WalletAccountAllOfAttributes available(Integer available) {
