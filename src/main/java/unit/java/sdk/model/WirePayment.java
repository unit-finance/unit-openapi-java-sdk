...
import unit.java.sdk.model.WirePaymentRelationships;
...
public class WirePayment extends Payment {
  ...
  private WirePaymentRelationships relationships;
  ...
  public WirePayment relationships(WirePaymentRelationships relationships) {
  ...
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public WirePaymentRelationships getRelationships() {
    return relationships;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RELATIONSHIPS)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setRelationships(WirePaymentRelationships relationships) {
    this.relationships = relationships;
  }


  @Override
  public WirePayment type(TypeEnum type) {
    this.setType(type);
    return this;
  }
