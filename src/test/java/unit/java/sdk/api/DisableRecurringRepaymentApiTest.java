...
/**
 * API tests for DisableRecurringRepaymentApi
 */
@Ignore
public class DisableRecurringRepaymentApiTest {

    private final DisableRecurringRepaymentApi api = new DisableRecurringRepaymentApi();
