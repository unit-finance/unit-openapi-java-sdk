...
/**
 * API tests for GetRecurringRepaymentApi
 */
@Ignore
public class GetRecurringRepaymentApiTest {

    private final GetRecurringRepaymentApi api = new GetRecurringRepaymentApi();
