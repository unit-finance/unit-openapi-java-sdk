...
/**
 * API tests for UploadAPdfDocumentForAnApplicationApi
 */
@Ignore
public class UploadAPdfDocumentForAnApplicationApiTest {

    private final UploadAPdfDocumentForAnApplicationApi api = new UploadAPdfDocumentForAnApplicationApi();
